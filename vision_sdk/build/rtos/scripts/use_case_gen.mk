...
TDA2XX_BIOS_USECASES = $(abspath ../../src/rtos/usecases)

TDA2XX_LINUX_USECASES = $(abspath ../../src/hlos/adas/src/usecases)
...
all:
	...
	$(USECASE_GEN_TOOL) -img -file -path $(TDA2XX_BIOS_USECASES)/tfdtprx_display  $(TDA2XX_BIOS_USECASES)/tfdtprx_display/chains_tfdtpRx_Display.txt
	...
	$(USECASE_GEN_TOOL) -img -file -path $(TDA2XX_LINUX_USECASES)/lvds_vip_multi_cam_view  $(TDA2XX_LINUX_USECASES)/lvds_vip_multi_cam_view/chains_lvdsVipMultiCam_vpeEncNull.txt
