...
# ECC_FFI_INCLUDE=yes is not supported for DDR_MEM_128M and TDA2XX_MC
...
# Supported D3 Radar board: TDA3XX_RADAR_RVP (FPD-Link)
#
RADAR_BOARD=TDA3XX_RADAR_RVP
...
include $(vision_sdk_PATH)/apps/configs/$(MAKECONFIG)/uc_cfg.mk
