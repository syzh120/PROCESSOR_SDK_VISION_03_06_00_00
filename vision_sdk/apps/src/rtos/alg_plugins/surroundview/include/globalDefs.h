...
Int32 focalLength; //focal length
Int8* data; //current sensor data
} Camera;
...
Int32 width; //image width
Int32 height; //image height
2DPoint distortionCenter; //distortion center for fisheye lense model
Int32 focalLength; //focal length
Int8 data; //current sensor data
} FishEyeCamera;
*/
...
#define MAX_EXTERNAL_MEMORY_SIZE		   500000000
