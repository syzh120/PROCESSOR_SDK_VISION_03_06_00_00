...
used to maintain the consistency of the system-wide value for _dtors_ptr,
...
/*** START TI ADD ***/
EXTERN_C void _DATA_ACCESS (*_dtors_ptr)(int);
/*** END TI ADD ***/
...
extern   void abort(void);
    ...
    /* THE USE OF _dtors_ptr ALLOWS US TO AVOID LINKING IN call_dtors()      */
    /* IF IT ISN'T USED.                                                     */
    /*-----------------------------------------------------------------------*/
    _dtors_ptr = ABI_NAMESPACE::__cxa_ia64_exit;
    __TI_data_synch_WBINV(&_dtors_ptr, sizeof(_dtors_ptr));
/*** END TI ADD ***/
    ndp->object = object;
