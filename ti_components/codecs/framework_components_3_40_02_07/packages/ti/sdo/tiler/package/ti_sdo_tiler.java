...
public class ti_sdo_tiler
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.sdo.tiler$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.sdo.tiler$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.sdo.tiler$$stat$root'];\n");
        sb.append("}\n");
