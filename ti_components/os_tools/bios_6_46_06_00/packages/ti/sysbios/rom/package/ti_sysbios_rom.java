...
public class ti_sysbios_rom
{
    ...
    void ROM$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.rom.ROM.F28004x_P2", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.F28004x_P2", 5));
        om.bind("ti.sysbios.rom.ROM.CC2650_FLASH", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2650_FLASH", 6));
    }
    ...
    void ROM$$SINGLETONS()
    {
        ...
        vo.bind("F28004x_P2", om.findStrict("ti.sysbios.rom.ROM.F28004x_P2", "ti.sysbios.rom"));
