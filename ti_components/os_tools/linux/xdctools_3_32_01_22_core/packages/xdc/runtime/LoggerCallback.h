...
/* defaultOutput */
__extern xdc_Void xdc_runtime_LoggerCallback_defaultOutput(xdc_UArg, xdc_runtime_Log_EventRec*, xdc_Int);

/* CreateInstFxn */
typedef xdc_UArg (*xdc_runtime_LoggerCallback_CreateInstFxn)(xdc_UArg);

/* defaultCreate */
__extern xdc_UArg xdc_runtime_LoggerCallback_defaultCreate(xdc_UArg);
...
#endif
/*
 *  @(#) xdc.runtime; 2, 1, 0,0; 7-26-2016 11:46:14; /db/ztree/library/trees/xdc/xdc-B21/src/packages/
 */
