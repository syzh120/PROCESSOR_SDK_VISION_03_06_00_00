...
#define ti_sdo_ipc_transports_TransportShm___VERS 160
...
__extern xdc_Int ti_sdo_ipc_transports_TransportShm_Instance_init__E(ti_sdo_ipc_transports_TransportShm_Object *, xdc_UInt16 procId, const ti_sdo_ipc_transports_TransportShm_Params *, xdc_runtime_Error_Block *);
...
__extern void ti_sdo_ipc_transports_TransportShm_Instance_finalize__E( ti_sdo_ipc_transports_TransportShm_Object* , int );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShm_Object__destruct__S, "ti_sdo_ipc_transports_TransportShm_Object__destruct__S")
