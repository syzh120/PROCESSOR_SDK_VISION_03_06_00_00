...
package/%.xdc.inc package/%_ti.ndk.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.ndk" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.ndk $@
...
.PHONY: release,ti_ndk
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_ndk.tar.dep
endif
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package/package.bld.xml
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package/build.cfg
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package.bld
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package.xdc
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: doxyfile
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: inc
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_ndk/ti/ndk/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_ndk.tar: package/rel/ti_ndk.xdc.inc package/rel/ti_ndk/ti/ndk/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_ndk.xdc.inc,package/rel/ti_ndk.tar.dep)


release release,ti_ndk: all ti_ndk.tar
clean:: .clean
	-$(RM) ti_ndk.tar
	-$(RM) package/rel/ti_ndk.xdc.inc
	-$(RM) package/rel/ti_ndk.tar.dep
