...
override PKGDIR = ti/ndk/hal/userled_stub
...
package/%.xdc.inc package/%_ti.ndk.hal.userled_stub.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.ndk.hal.userled_stub" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.ndk.hal.userled_stub $@

.libraries,em4f .libraries: lib/hal_userled_stub.aem4f

-include lib/hal_userled_stub.aem4f.mak
lib/hal_userled_stub.aem4f: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oem4f package/lib/lib/hal_userled_stub/llled.oem4f  into $@ ...
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armar  rq $@   package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oem4f package/lib/lib/hal_userled_stub/llled.oem4f 
lib/hal_userled_stub.aem4f: export C_DIR=
lib/hal_userled_stub.aem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

clean,em4f clean::
	-$(RM) lib/hal_userled_stub.aem4f
.libraries,e66 .libraries: lib/hal_userled_stub.ae66

-include lib/hal_userled_stub.ae66.mak
lib/hal_userled_stub.ae66: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oe66 package/lib/lib/hal_userled_stub/llled.oe66  into $@ ...
	$(ti.targets.elf.C66.rootDir)/bin/ar6x  rq $@   package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oe66 package/lib/lib/hal_userled_stub/llled.oe66 
lib/hal_userled_stub.ae66: export C_DIR=
lib/hal_userled_stub.ae66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

clean,e66 clean::
	-$(RM) lib/hal_userled_stub.ae66
.libraries,a15fg .libraries: lib/hal_userled_stub.aa15fg

-include lib/hal_userled_stub.aa15fg.mak
lib/hal_userled_stub.aa15fg: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oa15fg package/lib/lib/hal_userled_stub/llled.oa15fg  into $@ ...
	$(gnu.targets.arm.A15F.rootDir)/bin/arm-none-eabi-ar  cr $@   package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oa15fg package/lib/lib/hal_userled_stub/llled.oa15fg 
lib/hal_userled_stub.aa15fg: export LD_LIBRARY_PATH=

clean,a15fg clean::
	-$(RM) lib/hal_userled_stub.aa15fg
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.ndk.hal.userled_stub.oem4f,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oem4f
package_ti.ndk.hal.userled_stub.sem4f,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.sem4f
llled.oem4f,copy : package/lib/lib/hal_userled_stub/llled.oem4f
llled.sem4f,copy : package/lib/lib/hal_userled_stub/llled.sem4f
package_ti.ndk.hal.userled_stub.oe66,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oe66
package_ti.ndk.hal.userled_stub.se66,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.se66
llled.oe66,copy : package/lib/lib/hal_userled_stub/llled.oe66
llled.se66,copy : package/lib/lib/hal_userled_stub/llled.se66
package_ti.ndk.hal.userled_stub.oa15fg,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.oa15fg
package_ti.ndk.hal.userled_stub.sa15fg,copy : package/lib/lib/hal_userled_stub/package/package_ti.ndk.hal.userled_stub.sa15fg
llled.oa15fg,copy : package/lib/lib/hal_userled_stub/llled.oa15fg
llled.sa15fg,copy : package/lib/lib/hal_userled_stub/llled.sa15fg

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_ndk_hal_userled_stub
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_ndk_hal_userled_stub.tar.dep
endif
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package/package.bld.xml
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package/build.cfg
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package.bld
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: lib/hal_userled_stub.aem4f
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: package/package_ti.ndk.hal.userled_stub.c
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: llled.c
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: lib/hal_userled_stub.ae66
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: lib/hal_userled_stub.aa15fg
package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_ndk_hal_userled_stub.tar: package/rel/ti_ndk_hal_userled_stub.xdc.inc package/rel/ti_ndk_hal_userled_stub/ti/ndk/hal/userled_stub/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_ndk_hal_userled_stub.xdc.inc,package/rel/ti_ndk_hal_userled_stub.tar.dep)


release release,ti_ndk_hal_userled_stub: all ti_ndk_hal_userled_stub.tar
clean:: .clean
	-$(RM) ti_ndk_hal_userled_stub.tar
	-$(RM) package/rel/ti_ndk_hal_userled_stub.xdc.inc
	-$(RM) package/rel/ti_ndk_hal_userled_stub.tar.dep
...
ifeq (,$(wildcard package/lib/lib/hal_userled_stub))
    $(shell $(MKDIR) package/lib/lib/hal_userled_stub)
endif
ifeq (,$(wildcard package/lib/lib/hal_userled_stub/package))
    $(shell $(MKDIR) package/lib/lib/hal_userled_stub/package)
endif
endif
clean::
	-$(RMDIR) package
