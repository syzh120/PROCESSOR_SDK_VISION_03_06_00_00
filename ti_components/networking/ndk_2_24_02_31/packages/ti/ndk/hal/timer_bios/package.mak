...
override PKGDIR = ti/ndk/hal/timer_bios
...
package/%.xdc.inc package/%_ti.ndk.hal.timer_bios.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.ndk.hal.timer_bios" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.ndk.hal.timer_bios $@

.libraries,em4f .libraries: lib/hal_timer_bios.aem4f

-include lib/hal_timer_bios.aem4f.mak
lib/hal_timer_bios.aem4f: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oem4f package/lib/lib/hal_timer_bios/lltimer.oem4f  into $@ ...
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armar  rq $@   package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oem4f package/lib/lib/hal_timer_bios/lltimer.oem4f 
lib/hal_timer_bios.aem4f: export C_DIR=
lib/hal_timer_bios.aem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

clean,em4f clean::
	-$(RM) lib/hal_timer_bios.aem4f
.libraries,e66 .libraries: lib/hal_timer_bios.ae66

-include lib/hal_timer_bios.ae66.mak
lib/hal_timer_bios.ae66: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oe66 package/lib/lib/hal_timer_bios/lltimer.oe66  into $@ ...
	$(ti.targets.elf.C66.rootDir)/bin/ar6x  rq $@   package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oe66 package/lib/lib/hal_timer_bios/lltimer.oe66 
lib/hal_timer_bios.ae66: export C_DIR=
lib/hal_timer_bios.ae66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

clean,e66 clean::
	-$(RM) lib/hal_timer_bios.ae66
.libraries,a15fg .libraries: lib/hal_timer_bios.aa15fg

-include lib/hal_timer_bios.aa15fg.mak
lib/hal_timer_bios.aa15fg: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oa15fg package/lib/lib/hal_timer_bios/lltimer.oa15fg  into $@ ...
	$(gnu.targets.arm.A15F.rootDir)/bin/arm-none-eabi-ar  cr $@   package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oa15fg package/lib/lib/hal_timer_bios/lltimer.oa15fg 
lib/hal_timer_bios.aa15fg: export LD_LIBRARY_PATH=

clean,a15fg clean::
	-$(RM) lib/hal_timer_bios.aa15fg
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.ndk.hal.timer_bios.oem4f,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oem4f
package_ti.ndk.hal.timer_bios.sem4f,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.sem4f
lltimer.oem4f,copy : package/lib/lib/hal_timer_bios/lltimer.oem4f
lltimer.sem4f,copy : package/lib/lib/hal_timer_bios/lltimer.sem4f
package_ti.ndk.hal.timer_bios.oe66,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oe66
package_ti.ndk.hal.timer_bios.se66,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.se66
lltimer.oe66,copy : package/lib/lib/hal_timer_bios/lltimer.oe66
lltimer.se66,copy : package/lib/lib/hal_timer_bios/lltimer.se66
package_ti.ndk.hal.timer_bios.oa15fg,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.oa15fg
package_ti.ndk.hal.timer_bios.sa15fg,copy : package/lib/lib/hal_timer_bios/package/package_ti.ndk.hal.timer_bios.sa15fg
lltimer.oa15fg,copy : package/lib/lib/hal_timer_bios/lltimer.oa15fg
lltimer.sa15fg,copy : package/lib/lib/hal_timer_bios/lltimer.sa15fg

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_ndk_hal_timer_bios
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_ndk_hal_timer_bios.tar.dep
endif
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package/package.bld.xml
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package/build.cfg
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package.bld
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: lib/hal_timer_bios.aem4f
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: package/package_ti.ndk.hal.timer_bios.c
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: lltimer.c
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: lib/hal_timer_bios.ae66
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: lib/hal_timer_bios.aa15fg
package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_ndk_hal_timer_bios.tar: package/rel/ti_ndk_hal_timer_bios.xdc.inc package/rel/ti_ndk_hal_timer_bios/ti/ndk/hal/timer_bios/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_ndk_hal_timer_bios.xdc.inc,package/rel/ti_ndk_hal_timer_bios.tar.dep)


release release,ti_ndk_hal_timer_bios: all ti_ndk_hal_timer_bios.tar
clean:: .clean
	-$(RM) ti_ndk_hal_timer_bios.tar
	-$(RM) package/rel/ti_ndk_hal_timer_bios.xdc.inc
	-$(RM) package/rel/ti_ndk_hal_timer_bios.tar.dep
...
ifeq (,$(wildcard package/lib/lib/hal_timer_bios))
    $(shell $(MKDIR) package/lib/lib/hal_timer_bios)
endif
ifeq (,$(wildcard package/lib/lib/hal_timer_bios/package))
    $(shell $(MKDIR) package/lib/lib/hal_timer_bios/package)
endif
endif
clean::
	-$(RMDIR) package
