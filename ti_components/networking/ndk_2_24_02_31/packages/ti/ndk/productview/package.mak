...
override PKGDIR = ti/ndk/productview
...
package/%.xdc.inc package/%_ti.ndk.productview.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.ndk.productview" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.ndk.productview $@
...
.PHONY: release,ti_ndk_productview
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_ndk_productview.tar.dep
endif
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: package/package.bld.xml
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: package/build.cfg
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: package.bld
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: icons
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_ndk_productview.tar: package/rel/ti_ndk_productview.xdc.inc package/rel/ti_ndk_productview/ti/ndk/productview/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_ndk_productview.xdc.inc,package/rel/ti_ndk_productview.tar.dep)


release release,ti_ndk_productview: all ti_ndk_productview.tar
clean:: .clean
	-$(RM) ti_ndk_productview.tar
	-$(RM) package/rel/ti_ndk_productview.xdc.inc
	-$(RM) package/rel/ti_ndk_productview.tar.dep
