...
# FLAGS for the kernelc66 Files
KERNELC66ASMFLAGS =  -ea.s -c -k --strip_coff_underscore --mem_model:data=far -dOVERRIDE_RTS=0 
...
#Create Empty rule for dependency
$(KERNELC66ASMOBJS):lib\mathlib.ae66e.mk
lib\mathlib.ae66e.mk:
...
lib/mathlib.ae66e : $(KERNELC66COBJS) $(KERNELC66ASMOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
