...
#pragma DATA_SECTION(__pblock_vcop_deInterleaveYUV422IBE, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_deInterleaveYUV422IBE, __ALIGNOF__(int));
unsigned short __pblock_vcop_deInterleaveYUV422IBE[16];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(14), _AGEN(0), _VPAIR(18,16), __vcop_alws());
   ...
   unsigned short size)
{
   ...
   vcop_deInterleaveYUV422IBE_init(src, dst, dst_u, dst_v, size, __pblock_vcop_deInterleaveYUV422IBE);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_deInterleaveYUV422IBE_vloops(__pblock_vcop_deInterleaveYUV422IBE);
   ...
   unsigned short pblock[])
{
   ...
   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_deInterleaveYUV422IBE_vloops(pblock);
