...
#pragma DATA_SECTION(__pblock_vcop_fft_512_16ix16o_stage_1, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_512_16ix16o_stage_1, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_512_16ix16o_stage_1[38];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+128*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+128*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+128*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+128*sizeof(*pOutput)*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 32);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), 1568);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), (pitch) -(sizeof(*pInput)*2*128*4)*(((1))-1u) -(sizeof(*pInput)*2*8u)*(((128)/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(34), -1440);
   ...
   unsigned short saturationLimit)
{
   ...
   vcop_fft_512_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_512_16ix16o_stage_1);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_1_vloops(__pblock_vcop_fft_512_16ix16o_stage_1);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_1_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_512_16ix16o_stage_2, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_512_16ix16o_stage_2, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_512_16ix16o_stage_2[38];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+32*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+32*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+32*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+32*sizeof(*pOutput)*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 32);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), 416);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), (pitch) -(sizeof(*pInput)*2*32*4)*(((4))-1u) -(sizeof(*pInput)*2*8u)*(((32)/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(34), -288);
   __vcop_pblock_init32(pblock, __offset+_PREG(36), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(38), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*1);
   __offset += 38;
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_512_16ix16o_stage_2);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_2_vloops(__pblock_vcop_fft_512_16ix16o_stage_2);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_2_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_512_16ix16o_stage_3, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_512_16ix16o_stage_3, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_512_16ix16o_stage_3[50];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(40), 128);
   __vcop_pblock_init16(pblock, __offset+_PREG(41), (pitch) -(4*sizeof(*pInput)*2*(8*4))*((4)-1u) -(sizeof(*pInput)*2*(8*4))*((4)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(42), 16);
   __vcop_pblock_init16(pblock, __offset+_PREG(43), -44);
   __vcop_pblock_init16(pblock, __offset+_PREG(44), 2020);
   __vcop_pblock_init16(pblock, __offset+_PREG(45), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(46), -288);
   ...
   unsigned short pblock[])
{
   ...
   __vcop_vagen(_AGEN(1), _PREG(40), _PREG(40), _PREG(41), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(42), _PREG(43), _PREG(44), _PREG(0));
   __vcop_vagen(_AGEN(3), _PREG(45), _PREG(46), _PREG(46), _PREG(0));
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_512_16ix16o_stage_3);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_3_vloops(__pblock_vcop_fft_512_16ix16o_stage_3);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_3_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_512_16ix16o_stage_4, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_512_16ix16o_stage_4, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_512_16ix16o_stage_4[40];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pInput+2*(65*sizeof(*pOutput)*2)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pInput+2*(65*sizeof(*pOutput)*2)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pInput+2*(65*sizeof(*pOutput)*2)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pInput+2*(65*sizeof(*pOutput)*2)*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+8*2*8u*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+8*2*8u*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+8*2*8u*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+8*2*8u*sizeof(*pOutput)*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 260);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), -228);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), 1596);
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 256);
   __vcop_pblock_init16(pblock, __offset+_PREG(34), -224);
   __vcop_pblock_init16(pblock, __offset+_PREG(35), 1568);
   __vcop_pblock_init16(pblock, __offset+_PREG(36), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(37), -96);
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_4_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, __pblock_vcop_fft_512_16ix16o_stage_4);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_4_vloops(__pblock_vcop_fft_512_16ix16o_stage_4);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_stage_4_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_stage_4_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_512_16ix16o_radix2_stage_5, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_512_16ix16o_radix2_stage_5, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_512_16ix16o_radix2_stage_5[24];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pOutput+64*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(10), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pOutput+64*sizeof(*pOutput)*2*4);
   __vcop_pblock_init16(pblock, __offset+_PREG(16), -1504);
   __vcop_pblock_init16(pblock, __offset+_PREG(17), 288);
   __vcop_pblock_init16(pblock, __offset+_PREG(18), 256);
   __vcop_pblock_init16(pblock, __offset+_PREG(19), -736);
   __vcop_pblock_init16(pblock, __offset+_PREG(20), 1056);
   __vcop_pblock_init32(pblock, __offset+_PREG(22), (uchar *)pInput+64*sizeof(*pOutput)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pInput+64*sizeof(*pOutput)*2*1);
   __offset += 24;
...
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("Vx0", 16);
   #pragma VCC_VREG("Vx0_minus_x1", 17);
   #pragma VCC_VREG("Vx0_plus_x1", 18);
   #pragma VCC_VREG("Vx1", 19);
   #pragma VCC_VREG("Vy0", 20);
   #pragma VCC_VREG("Vy0_minus_y1", 21);
   #pragma VCC_VREG("Vy0_plus_y1", 22);
   #pragma VCC_VREG("Vy1", 23);
   ...
   __vcop_vloop(__vcop_compute(), 13u, 12u, 1u);
   __vcop_vagen(_AGEN(0), _PREG(7), _PREG(16), _PREG(17), _PREG(0));
   __vcop_vagen(_AGEN(1), _PREG(18), _PREG(19), _PREG(20), _PREG(0));
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(22), _AGEN(0), _VPAIR(16,20), __vcop_alws());
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(24), _AGEN(0), _VPAIR(19,23), __vcop_alws());
   __vcop_vmove(_VREG(16), _VREG(18));
   __vcop_vmove(_VREG(19), _VREG(17));
   __vcop_vaddsub(_VREG(18), _VREG(17));
   __vcop_vmove(_VREG(20), _VREG(22));
   __vcop_vmove(_VREG(23), _VREG(21));
   __vcop_vaddsub(_VREG(22), _VREG(21));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(18,22), _PREG(8), _AGEN(1), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(17,21), _PREG(14), _AGEN(1), _PREG(6));
   __vcop_vloop_end(1u);
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_radix2_stage_5_init(pInput, pOutput, numOfLines, scale, saturationLimit, __pblock_vcop_fft_512_16ix16o_radix2_stage_5);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_radix2_stage_5_vloops(__pblock_vcop_fft_512_16ix16o_radix2_stage_5);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_512_16ix16o_radix2_stage_5_init(pInput, pOutput, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_512_16ix16o_radix2_stage_5_vloops(pblock);
