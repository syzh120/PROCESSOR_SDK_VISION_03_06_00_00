#ifndef _TI_vcop_disparity_hammingDistance64_row_kernel_h_
#define _TI_vcop_disparity_hammingDistance64_row_kernel_h_

/* Parameter Register Block */
extern unsigned short __pblock_vcop_disparity_hammingDistance64_first_row_firstCall[106];
...
#define PARAM_SIZE_vcop_disparity_hammingDistance64_first_row_firstCall ((unsigned int)106)
unsigned int vcop_disparity_hammingDistance64_first_row_firstCall_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_disparity_hammingDistance64_first_row_firstCall ((unsigned int)0)
unsigned int vcop_disparity_hammingDistance64_first_row_firstCall_ctrl_count(void);

/***********************************************************/
/* Parameter Register Block */
extern unsigned short __pblock_vcop_disparity_hammingDistance64_first_row[88];
...
/* Parameter Register Count */
#define PARAM_SIZE_vcop_disparity_hammingDistance64_first_row ((unsigned int)88)
unsigned int vcop_disparity_hammingDistance64_first_row_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_disparity_hammingDistance64_first_row ((unsigned int)0)
unsigned int vcop_disparity_hammingDistance64_first_row_ctrl_count(void);

/***********************************************************/
/* Parameter Register Block */
extern unsigned short __pblock_vcop_disparity_hammingDistance64_nth_row_firstCall[154];
...
/* Parameter Register Count */
#define PARAM_SIZE_vcop_disparity_hammingDistance64_nth_row_firstCall ((unsigned int)154)
unsigned int vcop_disparity_hammingDistance64_nth_row_firstCall_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_disparity_hammingDistance64_nth_row_firstCall ((unsigned int)0)
unsigned int vcop_disparity_hammingDistance64_nth_row_firstCall_ctrl_count(void);

/***********************************************************/
/* Parameter Register Block */
extern unsigned short __pblock_vcop_disparity_hammingDistance64_nth_row[124];
...
/* Parameter Register Count */
#define PARAM_SIZE_vcop_disparity_hammingDistance64_nth_row ((unsigned int)124)
unsigned int vcop_disparity_hammingDistance64_nth_row_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_disparity_hammingDistance64_nth_row ((unsigned int)0)
