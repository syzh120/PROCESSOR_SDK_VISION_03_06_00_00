...
#pragma DATA_SECTION(__pblock_vcop_fft_N_16x16t_stages_initial, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_N_16x16t_stages_initial, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_N_16x16t_stages_initial[120];

unsigned short __ctrl_vcop_fft_N_16x16t_stages_initial[1];
   ...
   unsigned short pblock[])
{
   ...
   __ctrl_vcop_fft_N_16x16t_stages_initial[0] = passes - 1;
   ...
   unsigned short pblock[])
{
   ...
   __vcop_rpt(__ctrl_vcop_fft_N_16x16t_stages_initial[0]);
   ...
   unsigned short ptnc4[])
{
   ...
   vcop_fft_N_16x16t_stages_initial_init(Pxi0, Pxi1, Pxi2, Pxi3, PCS1, PCS2, PCS3, bfys_per_grp, grps, passes, pinc3, pinc4, ptnc3, ptnc4, __pblock_vcop_fft_N_16x16t_stages_initial);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stages_initial_vloops(__pblock_vcop_fft_N_16x16t_stages_initial);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_N_16x16t_stages_initial_init(Pxi0, Pxi1, Pxi2, Pxi3, PCS1, PCS2, PCS3, bfys_per_grp, grps, passes, pinc3, pinc4, ptnc3, ptnc4, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stages_initial_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_N_16x16t_stage_2ndLast, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_N_16x16t_stage_2ndLast, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_N_16x16t_stage_2ndLast[24];
   ...
   unsigned short ptnc4)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_N_16x16t_stage_2ndLast_init(Pxi0, Pxi1, Pxi2, Pxi3, PCS1, PCS2, PCS3, bfys_per_grp, grps, pinc3, pinc4, ptnc3, ptnc4, __pblock_vcop_fft_N_16x16t_stage_2ndLast);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stage_2ndLast_vloops(__pblock_vcop_fft_N_16x16t_stage_2ndLast);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_N_16x16t_stage_2ndLast_init(Pxi0, Pxi1, Pxi2, Pxi3, PCS1, PCS2, PCS3, bfys_per_grp, grps, pinc3, pinc4, ptnc3, ptnc4, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stage_2ndLast_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_N_16x16t_stage_Last, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_N_16x16t_stage_Last, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_N_16x16t_stage_Last[16];
   ...
   unsigned short pinc4)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_N_16x16t_stage_Last_init(Pxi0, Pxi1, Pxi2, Pxi3, bfys_per_grp, grps, pinc3, pinc4, __pblock_vcop_fft_N_16x16t_stage_Last);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stage_Last_vloops(__pblock_vcop_fft_N_16x16t_stage_Last);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_N_16x16t_stage_Last_init(Pxi0, Pxi1, Pxi2, Pxi3, bfys_per_grp, grps, pinc3, pinc4, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_N_16x16t_stage_Last_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_digit_rev_N, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_digit_rev_N, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_digit_rev_N[16];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (N/32)-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)Py);
   __vcop_pblock_init16(pblock, __offset+_PREG(8), 16);
   __vcop_pblock_init16(pblock, __offset+_PREG(9), (0) -(16)*((N/32)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(10), 128);
   __vcop_pblock_init16(pblock, __offset+_PREG(11), (32) -(128)*((N/32)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(12), (N) -(0)*((N/32)-1u));
   ...
   unsigned short N)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_digit_rev_N_init(Px, digit_rev, Py, N, __pblock_vcop_fft_digit_rev_N);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_digit_rev_N_vloops(__pblock_vcop_fft_digit_rev_N);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_digit_rev_N_init(Px, digit_rev, Py, N, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_digit_rev_N_vloops(pblock);
