...
#pragma DATA_SECTION(__pblock_vcop_disparity_hammingDistance32_RL_first_row_firstCall, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_disparity_hammingDistance32_RL_first_row_firstCall, __ALIGNOF__(int));
unsigned short __pblock_vcop_disparity_hammingDistance32_RL_first_row_firstCall[94];

unsigned int vcop_disparity_hammingDistance32_RL_first_row_firstCall_param_count(void)
{
   return 94u;
}

unsigned int vcop_disparity_hammingDistance32_RL_first_row_firstCall_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_disparity_hammingDistance32_RL_first_row_firstCall_init(
   __vptr_uint32 pLeft,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pRight);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(19), (disparityStep*4*1) -(leftStride)*((winHeight)-1u) -(4*1)*((winWidth)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(20), (rightStride) -(4*1)*((winWidth)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(21),  -(rightStride)*((winHeight)-1u) -(4*1)*((winWidth)-1u));
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight+1*(8u*4+(winWidth-1)*4));
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pLeft+1*(8u*4-4));
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pRight+1*(8u*4-4));
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(18), (disparityStep*1*4) -(8u*1*4)*(((((width-(8u)) + (8u)-1) & ~((8u)-1))/(8u))-1u) -(leftStride)*((winHeight)-1u));
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(21),  -(8u*1*4)*(((((width-(8u)) + (8u)-1) & ~((8u)-1))/(8u))-1u) -(rightStride)*((winHeight)-1u));
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pAllCostOutput+(numDisparities/disparityStep-1)*allCostOutputStride);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pAllCostOutput+(numDisparities/disparityStep-1)*allCostOutputStride+8u*sizeof(*pAllCostOutput));
...
void vcop_disparity_hammingDistance32_RL_first_row_firstCall_vloops(
   unsigned short pblock[])
{
...
void vcop_disparity_hammingDistance32_RL_first_row_firstCall(
   __vptr_uint32 pLeft,
   __vptr_uint32 pRight,
   unsigned short leftStride,
   unsigned short rightStride,
   ...
   unsigned short scratchStride)
{
   ...
   vcop_disparity_hammingDistance32_RL_first_row_firstCall_init(pLeft, pRight, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pCarryOverOut, scratchStride, __pblock_vcop_disparity_hammingDistance32_RL_first_row_firstCall);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_first_row_firstCall_vloops(__pblock_vcop_disparity_hammingDistance32_RL_first_row_firstCall);
...
void vcop_disparity_hammingDistance32_RL_first_row_firstCall_custom(
   __vptr_uint32 pLeft,
   __vptr_uint32 pRight,
   unsigned short leftStride,
   unsigned short rightStride,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_disparity_hammingDistance32_RL_first_row_firstCall_init(pLeft, pRight, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pCarryOverOut, scratchStride, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_first_row_firstCall_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_disparity_hammingDistance32_RL_first_row, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_disparity_hammingDistance32_RL_first_row, __ALIGNOF__(int));
unsigned short __pblock_vcop_disparity_hammingDistance32_RL_first_row[80];

unsigned int vcop_disparity_hammingDistance32_RL_first_row_param_count(void)
{
   return 80u;
}

unsigned int vcop_disparity_hammingDistance32_RL_first_row_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_disparity_hammingDistance32_RL_first_row_init(
   __vptr_uint32 pLeft,
   __vptr_uint32 pRight,
   unsigned short leftStride,
   unsigned short rightStride,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (winHeight)-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight+1*((winWidth-1)*4));
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pLeft-4*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pRight-4*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pScratch0);
   __vcop_pblock_init16(pblock, __offset+_PREG(14), (8u*scratchStride));
   __vcop_pblock_init16(pblock, __offset+_PREG(15), (sizeof(*pAllCostOutput)) -(8u*scratchStride)*(((((width) + (8u)-1) & ~((8u)-1))/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(16), (leftStride));
   __vcop_pblock_init16(pblock, __offset+_PREG(17), (8u*1*4) -(leftStride)*((winHeight)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(18), (disparityStep*1*4) -(8u*1*4)*(((((width) + (8u)-1) & ~((8u)-1))/(8u))-1u) -(leftStride)*((winHeight)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(19), (rightStride));
   __vcop_pblock_init16(pblock, __offset+_PREG(20), (8u*1*4) -(rightStride)*((winHeight)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(21),  -(8u*1*4)*(((((width) + (8u)-1) & ~((8u)-1))/(8u))-1u) -(rightStride)*((winHeight)-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(22), 0);
...
void vcop_disparity_hammingDistance32_RL_first_row_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("vDisparityStep", 16);
...
void vcop_disparity_hammingDistance32_RL_first_row(
   __vptr_uint32 pLeft,
   __vptr_uint32 pRight,
   unsigned short leftStride,
   unsigned short rightStride,
   ...
   unsigned short scratchStride)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_disparity_hammingDistance32_RL_first_row_init(pLeft, pRight, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pCarryOverIn, pCarryOverOut, scratchStride, __pblock_vcop_disparity_hammingDistance32_RL_first_row);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_first_row_vloops(__pblock_vcop_disparity_hammingDistance32_RL_first_row);
...
void vcop_disparity_hammingDistance32_RL_first_row_custom(
   __vptr_uint32 pLeft,
   __vptr_uint32 pRight,
   unsigned short leftStride,
   unsigned short rightStride,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_disparity_hammingDistance32_RL_first_row_init(pLeft, pRight, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pCarryOverIn, pCarryOverOut, scratchStride, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_first_row_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_disparity_hammingDistance32_RL_nth_row_firstCall, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_disparity_hammingDistance32_RL_nth_row_firstCall, __ALIGNOF__(int));
unsigned short __pblock_vcop_disparity_hammingDistance32_RL_nth_row_firstCall[150];

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_firstCall_param_count(void)
{
   return 150u;
}

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_firstCall_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_firstCall_init(
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(2), 0);
   __vcop_pblock_init16(pblock, __offset+_PREG(3), 0);
   __vcop_pblock_init16(pblock, __offset+_PREG(4), ((((width-(8u)) + (2*(8u))-1) & ~(2*(8u)-1))/(2*(8u)))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), ((numDisparities/disparityStep))-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight_lastRow+1*8u*4+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pRight_lastRow+1*8u*4+1*4*(winWidth-1)+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pLeft_prevRow+1*8u*4-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pLeft_prevRow+1*8u*4-1*4+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pLeft_lastRow+1*8u*4+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pLeft_lastRow+1*8u*4+1*4*(winWidth-1)+8u*4);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(23), (disparityStep*4*1));
   __vcop_pblock_init16(pblock, __offset+_PREG(24), ((2*8u)*4*1) -(disparityStep*4*1)*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(25), ((width-8u+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput)));
   __vcop_pblock_init16(pblock, __offset+_PREG(26), ((2*8u)*sizeof(*pAllCostOutput)) -((width-8u+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput))*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pRight_prevRow+1*8u*4-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pRight_prevRow+1*8u*4-1*4+8u*4);
   __offset += 30;
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), ((((width-(8u)) + (2*(8u))-1) & ~(2*(8u)-1))/(2*(8u)))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), ((numDisparities/disparityStep))-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight_lastRow+1*8u*4-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pRight_lastRow+1*8u*4-1*4+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pLeft_prevRow+1*8u*4+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pLeft_prevRow+1*8u*4+1*4*(winWidth-1)+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pLeft_lastRow+1*8u*4-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pLeft_lastRow+1*8u*4-1*4+8u*4);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(25), ((width-8u+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput)));
   __vcop_pblock_init16(pblock, __offset+_PREG(26), ((2*8u)*sizeof(*pAllCostOutput)) -((width-8u+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput))*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pRight_prevRow+1*8u*4+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pRight_prevRow+1*8u*4+1*4*(winWidth-1)+8u*4);
   __offset += 30;
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(12), 16);
   __vcop_pblock_init16(pblock, __offset+_PREG(13), ((width-8u+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput)) -(8u*sizeof(*pAllCostOutput))*(((((width-(8u)) + (8u)-1) & ~((8u)-1))/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(14), (8u*scratchStride));
   __vcop_pblock_init16(pblock, __offset+_PREG(15), (sizeof(*pAllCostOutput)) -(8u*scratchStride)*(((((width-(8u)) + (8u)-1) & ~((8u)-1))/(8u))-1u));
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), ((numDisparities/disparityStep))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (winWidth)-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight_lastRow);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pLeft_prevRow);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pRight_prevRow);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pScratch2);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pCarryOverOut);
   __vcop_pblock_init16(pblock, __offset+_PREG(16), (allCostOutputStride));
   __vcop_pblock_init16(pblock, __offset+_PREG(17), 4);
   __vcop_pblock_init16(pblock, __offset+_PREG(18), (disparityStep*4*1) -(4*1)*((winWidth)-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(19), (0) -(4*1)*((winWidth)-1u));
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pAllCostOutput+(numDisparities/disparityStep-1)*allCostOutputStride);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pAllCostOutput+(numDisparities/disparityStep-1)*allCostOutputStride+8u*sizeof(*pAllCostOutput));
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pScratch2+(numDisparities/disparityStep-1)*allCostOutputStride);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pScratch2+(numDisparities/disparityStep-1)*allCostOutputStride+8u*sizeof(*pScratch2));
...
void vcop_disparity_hammingDistance32_RL_nth_row_firstCall_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("vDisparityStep", 16);
   ...
   /* VLOOP Local Vector Registers */
   #pragma VCC_VREG("vRightBR0", 17);
   #pragma VCC_VREG("vRightBR1", 18);
   #pragma VCC_VREG("vRightUL0", 19);
   #pragma VCC_VREG("vRightUL1", 20);
   #pragma VCC_VREG("vLeftBR0", 21);
   #pragma VCC_VREG("vLeftBR1", 22);
   #pragma VCC_VREG("vLeftUL0", 23);
   #pragma VCC_VREG("vLeftUL1", 24);
   #pragma VCC_VREG("vPtDiffPos0", 25);
   #pragma VCC_VREG("vPtDiffPos1", 26);
   ...
   /* VLOOP Local Address Generators */
   #pragma EVE_REG("agenRight", "A0");
   #pragma EVE_REG("agenLeft", "A1");
   #pragma EVE_REG("agenOut", "A2");
   /* VLOOP Loop Control Variables   */
   #pragma EVE_REG("c", "I3");
   #pragma EVE_REG("d", "I4");
   ...
   __vcop_vagen(_AGEN(1), _PREG(23), _PREG(24), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(25), _PREG(26), _PREG(0), _PREG(0));
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(28), _AGEN(0), _VREG(19), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(30), _AGEN(0), _VREG(20), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(6), _AGEN(0), _VREG(17), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(8), _AGEN(0), _VREG(18), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(10), _AGEN(1), _VREG(23), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(12), _AGEN(1), _VREG(24), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(14), _AGEN(1), _VREG(21), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(16), _AGEN(1), _VREG(22), __vcop_alws());
   __vcop_vxor(_VREG(23), _VREG(19), _VREG(29));
   __vcop_vxor(_VREG(24), _VREG(20), _VREG(30));
   __vcop_vbitc(_VREG(29), _VREG(29));
   __vcop_vbitc(_VREG(30), _VREG(30));
   __vcop_vxor(_VREG(21), _VREG(17), _VREG(27));
   __vcop_vxor(_VREG(22), _VREG(18), _VREG(28));
   __vcop_vbitc(_VREG(27), _VREG(27));
   __vcop_vbitc(_VREG(28), _VREG(28));
   __vcop_vadd(_VREG(29), _VREG(27), _VREG(25));
   __vcop_vadd(_VREG(30), _VREG(28), _VREG(26));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_npt(), __vcop_alws(), _VREG(25), _PREG(18), _AGEN(2), _PREG(0));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_npt(), __vcop_alws(), _VREG(26), _PREG(20), _AGEN(2), _PREG(0));
   __vcop_vloop_end(1u);

   /* VLOOP 2 Start */

   /* VLOOP Local Vector Registers */
   #pragma VCC_VREG("vRightBL0", 31);
   #pragma VCC_VREG("vRightBL1", 32);
   #pragma VCC_VREG("vRightUR0", 33);
   #pragma VCC_VREG("vRightUR1", 34);
   #pragma VCC_VREG("vLeftBL0", 35);
   #pragma VCC_VREG("vLeftBL1", 36);
   #pragma VCC_VREG("vLeftUR0", 37);
   #pragma VCC_VREG("vLeftUR1", 38);
   #pragma VCC_VREG("vPtDiffNeg0", 39);
   #pragma VCC_VREG("vPtDiffNeg1", 40);
   ...
   __vcop_vagen(_AGEN(1), _PREG(23), _PREG(24), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(25), _PREG(26), _PREG(0), _PREG(0));
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(28), _AGEN(0), _VREG(33), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(30), _AGEN(0), _VREG(34), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(6), _AGEN(0), _VREG(31), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(8), _AGEN(0), _VREG(32), __vcop_i4_zero());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(10), _AGEN(1), _VREG(37), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(12), _AGEN(1), _VREG(38), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(14), _AGEN(1), _VREG(35), __vcop_alws());
   __vcop_vload(__vcop_sizeWU(), __vcop_npt(), _PREG(16), _AGEN(1), _VREG(36), __vcop_alws());
   __vcop_vxor(_VREG(37), _VREG(33), _VREG(43));
   __vcop_vxor(_VREG(38), _VREG(34), _VREG(44));
   __vcop_vbitc(_VREG(43), _VREG(43));
   __vcop_vbitc(_VREG(44), _VREG(44));
   __vcop_vxor(_VREG(35), _VREG(31), _VREG(41));
   __vcop_vxor(_VREG(36), _VREG(32), _VREG(42));
   __vcop_vbitc(_VREG(41), _VREG(41));
   __vcop_vbitc(_VREG(42), _VREG(42));
   __vcop_vadd(_VREG(43), _VREG(41), _VREG(39));
   __vcop_vadd(_VREG(44), _VREG(42), _VREG(40));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_npt(), __vcop_alws(), _VREG(39), _PREG(18), _AGEN(2), _PREG(0));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_npt(), __vcop_alws(), _VREG(40), _PREG(20), _AGEN(2), _PREG(0));
   __vcop_vloop_end(2u);
...
void vcop_disparity_hammingDistance32_RL_nth_row_firstCall(
   __vptr_uint32 pLeft_prevRow,
   __vptr_uint32 pLeft_lastRow,
   __vptr_uint32 pRight_prevRow,
   __vptr_uint32 pRight_lastRow,
   ...
   unsigned short scratchStride)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_disparity_hammingDistance32_RL_nth_row_firstCall_init(pLeft_prevRow, pLeft_lastRow, pRight_prevRow, pRight_lastRow, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pScratch1, pScratch2, pCarryOverOut, scratchStride, __pblock_vcop_disparity_hammingDistance32_RL_nth_row_firstCall);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_nth_row_firstCall_vloops(__pblock_vcop_disparity_hammingDistance32_RL_nth_row_firstCall);
...
void vcop_disparity_hammingDistance32_RL_nth_row_firstCall_custom(
   __vptr_uint32 pLeft_prevRow,
   __vptr_uint32 pLeft_lastRow,
   __vptr_uint32 pRight_prevRow,
   __vptr_uint32 pRight_lastRow,
   ...
   unsigned short pblock[])
{
   ...
   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_nth_row_firstCall_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_disparity_hammingDistance32_RL_nth_row, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_disparity_hammingDistance32_RL_nth_row, __ALIGNOF__(int));
unsigned short __pblock_vcop_disparity_hammingDistance32_RL_nth_row[128];

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_param_count(void)
{
   return 128u;
}

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_disparity_hammingDistance32_RL_nth_row_init(
   __vptr_uint32 pLeft_prevRow,
   __vptr_uint32 pLeft_lastRow,
   __vptr_uint32 pRight_prevRow,
   __vptr_uint32 pRight_lastRow,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), ((((width) + (2*(8u))-1) & ~(2*(8u)-1))/(2*(8u)))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), ((numDisparities/disparityStep))-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight_lastRow+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pRight_lastRow+1*4*(winWidth-1)+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pLeft_prevRow-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pLeft_prevRow-1*4+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pLeft_lastRow+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pLeft_lastRow+1*4*(winWidth-1)+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pScratch1);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pScratch1+8u*sizeof(*pScratch1));
   __vcop_pblock_init16(pblock, __offset+_PREG(22), 64);
   __vcop_pblock_init16(pblock, __offset+_PREG(23), (disparityStep*4*1));
   __vcop_pblock_init16(pblock, __offset+_PREG(24), ((2*8u)*4*1) -(disparityStep*4*1)*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(25), ((width+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput)));
   __vcop_pblock_init16(pblock, __offset+_PREG(26), ((2*8u)*sizeof(*pAllCostOutput)) -((width+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput))*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pRight_prevRow-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pRight_prevRow-1*4+8u*4);
   __offset += 30;
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), ((((width) + (2*(8u))-1) & ~(2*(8u)-1))/(2*(8u)))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), ((numDisparities/disparityStep))-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pRight_lastRow-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pRight_lastRow-1*4+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pLeft_prevRow+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pLeft_prevRow+1*4*(winWidth-1)+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pLeft_lastRow-1*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pLeft_lastRow-1*4+8u*4);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pScratch2);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pScratch2+8u*sizeof(*pScratch2));
   __vcop_pblock_init16(pblock, __offset+_PREG(22), 64);
   __vcop_pblock_init16(pblock, __offset+_PREG(23), (disparityStep*4*1));
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(25), ((width+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput)));
   __vcop_pblock_init16(pblock, __offset+_PREG(26), ((2*8u)*sizeof(*pAllCostOutput)) -((width+2*8u-1&~(2*8u-1))*sizeof(*pAllCostOutput))*(((numDisparities/disparityStep))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pRight_prevRow+1*4*(winWidth-1));
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pRight_prevRow+1*4*(winWidth-1)+8u*4);
   __offset += 30;
...
void vcop_disparity_hammingDistance32_RL_nth_row_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("vDisparityStep", 16);
...
void vcop_disparity_hammingDistance32_RL_nth_row(
   __vptr_uint32 pLeft_prevRow,
   __vptr_uint32 pLeft_lastRow,
   __vptr_uint32 pRight_prevRow,
   __vptr_uint32 pRight_lastRow,
   ...
   unsigned short scratchStride)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_disparity_hammingDistance32_RL_nth_row_init(pLeft_prevRow, pLeft_lastRow, pRight_prevRow, pRight_lastRow, leftStride, rightStride, winWidth, winHeight, pDisparityOutput, pMinCostOutput, pAllCostOutput, allCostOutputStride, width, numDisparities, disparityStep, pCollateMask, pOffset, pScratch0, pScratch1, pScratch2, pCarryOverIn, pCarryOverOut, scratchStride, __pblock_vcop_disparity_hammingDistance32_RL_nth_row);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_nth_row_vloops(__pblock_vcop_disparity_hammingDistance32_RL_nth_row);
...
void vcop_disparity_hammingDistance32_RL_nth_row_custom(
   __vptr_uint32 pLeft_prevRow,
   __vptr_uint32 pLeft_lastRow,
   __vptr_uint32 pRight_prevRow,
   __vptr_uint32 pRight_lastRow,
   ...
   unsigned short pblock[])
{
   ...
   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_disparity_hammingDistance32_RL_nth_row_vloops(pblock);
