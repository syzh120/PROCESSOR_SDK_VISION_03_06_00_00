#ifndef _TI_vcop_HorzUpsample_kernel_h_
#define _TI_vcop_HorzUpsample_kernel_h_

/* Parameter Register Block */
extern unsigned short __pblock_vcop_HorzUpsample_ushort_short_ushort[22];
...
#define PARAM_SIZE_vcop_HorzUpsample_ushort_short_ushort ((unsigned int)22)
unsigned int vcop_HorzUpsample_ushort_short_ushort_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_HorzUpsample_ushort_short_ushort ((unsigned int)0)
