...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_1_overflow, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_1_overflow, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_1_overflow[114];

unsigned int vcop_fft_128_16ix16o_stage_1_overflow_param_count(void)
{
   return 114u;
}

unsigned int vcop_fft_128_16ix16o_stage_1_overflow_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_1_overflow_init(
   __vptr_int16 pInput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), 2147483647);
   __vcop_pblock_init32(pblock, __offset+_PREG(22), (uchar *)pScratchH+32*sizeof(*pScratchH)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pScratchH+32*sizeof(*pScratchH)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pScratchH+32*sizeof(*pScratchH)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(32), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(34), (uchar *)pScratchH+32*sizeof(*pScratchH)*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(36), 416);
   __vcop_pblock_init16(pblock, __offset+_PREG(37), (pitch) -(sizeof(*pInput)*2*32*4)*(((1))-1u) -(sizeof(*pInput)*2*8u)*(((32)/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(38), (pitch) -(sizeof(*pScratchWBUF)*32*4)*(((1))-1u) -(sizeof(*pScratchWBUF)*8u)*(((32)/(8u))-1u));
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(10), (pitch) -(sizeof(*pScratchWBUF)*32*4)*(((1))-1u) -(sizeof(*pScratchWBUF)*8u)*(((32)/(8u))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pScratchH+32*sizeof(*pScratchH)*0);
   __offset += 14;
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pScratchH+32*sizeof(*pScratchH)*1);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(14), (pitch) -(sizeof(*pScratchWBUF)*32*4)*(((1))-1u) -(sizeof(*pScratchWBUF)*8u)*(((32)/(8u))-1u) -(32*sizeof(*pScratchWBUF))*((3)-1u));
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pScratchWBUF+32*sizeof(*pScratchWBUF)*1);
   __offset += 20;

   return 114u;
}

void vcop_fft_128_16ix16o_stage_1_overflow_vloops(
   unsigned short pblock[])
{
   ...
   #pragma VCC_VREG("VInterim5", 24);
   #pragma VCC_VREG("VInterim6", 25);
   ...
   #pragma VCC_VREG("VScaleIn", 38);
   #pragma VCC_VREG("VScaleMinus", 39);
   ...
   __vcop_vinit(__vcop_sizeWU(), __vcop_once(), _PREG(42), _VREG(27));
   ...
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(16), _AGEN(1), _VPAIR(49,57), __vcop_alws());
   ...
   __vcop_vmove(_VREG(44), _VREG(29));
   __vcop_vmove(_VREG(47), _VREG(31));
   __vcop_vaddsub(_VREG(29), _VREG(31));
   __vcop_vmove(_VREG(43), _VREG(30));
   __vcop_vmove(_VREG(54), _VREG(32));
   __vcop_vaddsub(_VREG(30), _VREG(32));
   __vcop_vmove(_VREG(52), _VREG(34));
   __vcop_vmove(_VREG(55), _VREG(36));
   __vcop_vaddsub(_VREG(34), _VREG(36));
   __vcop_vmove(_VREG(51), _VREG(37));
   __vcop_vmove(_VREG(46), _VREG(35));
   __vcop_vaddsub(_VREG(37), _VREG(35));
   __vcop_vmin(_VREG(29), _VREG(31), _VREG(20));
   __vcop_vmax(_VREG(29), _VREG(31), _VREG(21));
   __vcop_vmin(_VREG(30), _VREG(32), _VREG(22));
   __vcop_vmax(_VREG(30), _VREG(32), _VREG(23));
   __vcop_vmin(_VREG(20), _VREG(22), _VREG(20));
   __vcop_vmax(_VREG(21), _VREG(23), _VREG(21));
   __vcop_vmin(_VREG(34), _VREG(36), _VREG(22));
   __vcop_vmax(_VREG(34), _VREG(36), _VREG(23));
   __vcop_vmin(_VREG(20), _VREG(22), _VREG(20));
   __vcop_vmax(_VREG(21), _VREG(23), _VREG(21));
   __vcop_vmin(_VREG(37), _VREG(35), _VREG(22));
   __vcop_vmax(_VREG(37), _VREG(35), _VREG(23));
   __vcop_vmin(_VREG(20), _VREG(22), _VREG(20));
   __vcop_vmax(_VREG(21), _VREG(23), _VREG(21));
   __vcop_vmin(_VREG(27), _VREG(20), _VREG(27));
   __vcop_vmax(_VREG(26), _VREG(21), _VREG(26));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(29), _PREG(18), _AGEN(3), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(34), _PREG(22), _AGEN(2), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(30), _PREG(24), _AGEN(3), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(35), _PREG(26), _AGEN(2), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(31), _PREG(28), _AGEN(3), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(36), _PREG(30), _AGEN(2), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(32), _PREG(32), _AGEN(3), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(37), _PREG(34), _AGEN(2), _PREG(6));
   __vcop_vloop_end(1u);
   ...
   __vcop_vcmplt(_VREG(27), _VREG(58), _VREG(65));
   __vcop_vor(_VREG(60), _VREG(60), _VREG(66));
   __vcop_vsel(_VREG(65), _VREG(27), _VREG(66));
   __vcop_vcmplt(_VREG(26), _VREG(58), _VREG(65));
   __vcop_vor(_VREG(60), _VREG(60), _VREG(67));
   __vcop_vsel(_VREG(65), _VREG(26), _VREG(67));
   __vcop_vlmbd(_VREG(66), _VREG(58), _VREG(61));
   __vcop_vlmbd(_VREG(67), _VREG(58), _VREG(62));
   __vcop_vmax(_VREG(61), _VREG(62), _VREG(63));
   __vcop_vcmpge(_VREG(27), _VREG(58), _VREG(65));
   __vcop_vor(_VREG(58), _VREG(58), _VREG(68));
   __vcop_vsel(_VREG(65), _VREG(27), _VREG(68));
   __vcop_vcmpge(_VREG(26), _VREG(58), _VREG(65));
   __vcop_vor(_VREG(58), _VREG(58), _VREG(69));
   __vcop_vsel(_VREG(65), _VREG(26), _VREG(69));
   ...
   /* VLOOP Local Vector Registers */
   #pragma VCC_VREG("VKMinus1", 70);
   #pragma VCC_VREG("VLmbd", 71);
   #pragma VCC_VREG("VNumValidBits", 72);
   #pragma VCC_VREG("VScale", 73);
   ...
   __vcop_vinit(__vcop_sizeW(), __vcop_once(), _PREG(18), _VREG(41));
   __vcop_vinit(__vcop_sizeW(), __vcop_alws(), _PREG(8), _VREG(70));
   __vcop_vinit(__vcop_sizeW(), __vcop_alws(), _PREG(10), _VREG(72));
   __vcop_vagen(_AGEN(0), _PREG(0), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(1), _PREG(7), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vload(__vcop_sizeBU(), __vcop_1pt(), _PREG(20), _AGEN(0), _VREG(38), __vcop_once());
   __vcop_vload(__vcop_sizeH(), __vcop_1pt(), _PREG(12), _AGEN(1), _VREG(71), __vcop_alws());
   __vcop_vmax(_VREG(71), _VREG(41), _VREG(41));
   __vcop_vsub(_VREG(41), _VREG(72), _VREG(73));
   __vcop_vmax(_VREG(38), _VREG(73), _VREG(73));
   __vcop_vmpy(_VREG(73), _VREG(70), _VREG(39), _PREG(0));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeBU(), __vcop_1pt(), __vcop_alws(), _VREG(73), _PREG(20), _AGEN(0), _PREG(6));
   __vcop_vloop_end(3u);
   ...
   __vcop_vshf(_VREG(18), _VREG(39), _VREG(28));
   __vcop_vshf(_VREG(19), _VREG(39), _VREG(33));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(28,33), _PREG(6), _AGEN(3), _PREG(0));
   __vcop_vloop_end(4u);
   ...
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(18), _AGEN(4), _VPAIR(40,17), __vcop_alws());
   ...
   __vcop_vshf(_VREG(18), _VREG(39), _VREG(18));
   __vcop_vshf(_VREG(19), _VREG(39), _VREG(19));
   __vcop_vmpy(_VREG(18), _VREG(17), _VREG(28), _PREG(0));
   __vcop_vmpy(_VREG(19), _VREG(17), _VREG(33), _PREG(0));
   __vcop_vmadd(_VREG(19), _VREG(40), _VREG(28), _PREG(0));
   __vcop_vmsub(_VREG(18), _VREG(40), _VREG(33), _PREG(0));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(28,33), _PREG(10), _AGEN(3), _PREG(6));
   __vcop_vloop_end(5u);

}

void vcop_fft_128_16ix16o_stage_1_overflow(
   __vptr_int16 pInput,
   __vptr_int32 pScratchWBUF,
   __vptr_int32 pScratchH,
   __vptr_int16 pOutput,
   ...
   unsigned short saturationLimit)
{
   ...
   vcop_fft_128_16ix16o_stage_1_overflow_init(pInput, pScratchWBUF, pScratchH, pOutput, pTwiddleFactor, pScaleFactor, numValidBits, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_1_overflow);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_1_overflow_vloops(__pblock_vcop_fft_128_16ix16o_stage_1_overflow);
...
void vcop_fft_128_16ix16o_stage_1_overflow_custom(
   __vptr_int16 pInput,
   __vptr_int32 pScratchWBUF,
   __vptr_int32 pScratchH,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_1_overflow_init(pInput, pScratchWBUF, pScratchH, pOutput, pTwiddleFactor, pScaleFactor, numValidBits, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_1_overflow_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_2_overflow, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_2_overflow, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_2_overflow[118];

unsigned int vcop_fft_128_16ix16o_stage_2_overflow_param_count(void)
{
   return 118u;
}

unsigned int vcop_fft_128_16ix16o_stage_2_overflow_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_2_overflow_init(
   __vptr_int16 pInput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(38), (pitch) -((8*4)*sizeof(*pInput)*2)*(((4))-1u));
   __vcop_pblock_init32(pblock, __offset+_PREG(40), 1);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(12), 532);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(16), -28);
   __vcop_pblock_init16(pblock, __offset+_PREG(17), 500);
   __vcop_pblock_init16(pblock, __offset+_PREG(18), -352);
...
void vcop_fft_128_16ix16o_stage_2_overflow_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VCond", 16);
   ...
   __vcop_vagen(_AGEN(1), _PREG(7), _PREG(14), _PREG(14), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(15), _PREG(16), _PREG(17), _PREG(0));
   __vcop_vagen(_AGEN(3), _PREG(7), _PREG(7), _PREG(18), _PREG(0));
...
void vcop_fft_128_16ix16o_stage_2_overflow(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_2_overflow_init(pInput, pScratch1, pScratch2, pOutput, pTwiddleFactor, pScatterOffset, pScaleFactor, numValidBits, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_2_overflow);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_2_overflow_vloops(__pblock_vcop_fft_128_16ix16o_stage_2_overflow);
...
void vcop_fft_128_16ix16o_stage_2_overflow_custom(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_2_overflow_init(pInput, pScratch1, pScratch2, pOutput, pTwiddleFactor, pScatterOffset, pScaleFactor, numValidBits, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_2_overflow_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_3_overflow, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_3_overflow, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_3_overflow[116];

unsigned int vcop_fft_128_16ix16o_stage_3_overflow_param_count(void)
{
   return 116u;
}

unsigned int vcop_fft_128_16ix16o_stage_3_overflow_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_3_overflow_init(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(8), 0x8000000000);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pInput+2*(17*sizeof(*pOutput)*2)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pInput+2*(17*sizeof(*pOutput)*2)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pInput+2*(17*sizeof(*pOutput)*2)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pInput+2*(17*sizeof(*pOutput)*2)*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*1*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), 2147483647);
   __vcop_pblock_init32(pblock, __offset+_PREG(22), (uchar *)pScratch2+2*8u*sizeof(*pScratch2)*0*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*1*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pScratch2+2*8u*sizeof(*pScratch2)*1*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*1*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pScratch2+2*8u*sizeof(*pScratch2)*1*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(32), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*1*2*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(34), (uchar *)pScratch2+2*8u*sizeof(*pScratch2)*1*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(36), -36);
   __vcop_pblock_init16(pblock, __offset+_PREG(37), 444);
   __vcop_pblock_init16(pblock, __offset+_PREG(38), 64);
   __vcop_pblock_init16(pblock, __offset+_PREG(39), -32);
   __vcop_pblock_init16(pblock, __offset+_PREG(40), 416);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), (2)-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (2)-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2*0);
   __vcop_pblock_init16(pblock, __offset+_PREG(8), 64);
   __vcop_pblock_init16(pblock, __offset+_PREG(9), -32);
   __vcop_pblock_init16(pblock, __offset+_PREG(10), 416);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pScratch2+2*8u*sizeof(*pScratch1)*2*0);
   __offset += 14;
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(6), __vcop_store_round_sat(SM_NONE,0,RM_ROUND,15));
   __vcop_pblock_init16(pblock, __offset+_PREG(7), 128);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pScratch2+2*8u*sizeof(*pScratch1)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2);
   __vcop_pblock_init16(pblock, __offset+_PREG(12), -192);
   __vcop_pblock_init16(pblock, __offset+_PREG(13), -288);
   __vcop_pblock_init16(pblock, __offset+_PREG(14), 160);
   __vcop_pblock_init16(pblock, __offset+_PREG(15), 32);
   __vcop_pblock_init16(pblock, __offset+_PREG(16), -160);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pScratch1+2*8u*sizeof(*pScratch1)*2);
   __offset += 20;

   return 116u;
}

void vcop_fft_128_16ix16o_stage_3_overflow_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VCond", 16);
   ...
   __vcop_vinit(__vcop_sizeWU(), __vcop_once(), _PREG(44), _VREG(27));
   __vcop_vinit(__vcop_sizeW(), __vcop_once(), _PREG(8), _VREG(26));
   __vcop_vagen(_AGEN(1), _PREG(7), _PREG(36), _PREG(37), _PREG(0));
   ...
   __vcop_vmin(_VREG(27), _VREG(20), _VREG(27));
   __vcop_vmax(_VREG(26), _VREG(21), _VREG(26));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(29), _PREG(18), _AGEN(2), _PREG(6));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeW(), __vcop_npt(), __vcop_alws(), _VREG(34), _PREG(22), _AGEN(2), _PREG(6));
   ...
   __vcop_vshf(_VREG(18), _VREG(39), _VREG(28));
   __vcop_vshf(_VREG(19), _VREG(39), _VREG(33));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(28,33), _PREG(6), _AGEN(2), _PREG(0));
   __vcop_vloop_end(4u);
   ...
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(18), _AGEN(3), _VPAIR(40,17), __vcop_alws());
   ...
   __vcop_vmadd(_VREG(19), _VREG(40), _VREG(28), _PREG(0));
   __vcop_vmsub(_VREG(18), _VREG(40), _VREG(33), _PREG(0));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeH(), __vcop_intrlv(), __vcop_alws(), _VPAIR(28,33), _PREG(10), _AGEN(2), _PREG(6));
   __vcop_vloop_end(5u);

}

void vcop_fft_128_16ix16o_stage_3_overflow(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_3_overflow_init(pInput, pScratch1, pScratch2, pOutput, pTwiddleFactor, pScaleFactor, numValidBits, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_3_overflow);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_3_overflow_vloops(__pblock_vcop_fft_128_16ix16o_stage_3_overflow);
...
void vcop_fft_128_16ix16o_stage_3_overflow_custom(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_3_overflow_init(pInput, pScratch1, pScratch2, pOutput, pTwiddleFactor, pScaleFactor, numValidBits, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_3_overflow_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_radix2_stage_4_overflow, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_radix2_stage_4_overflow, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_radix2_stage_4_overflow[74];

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_overflow_param_count(void)
{
   return 74u;
}

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_overflow_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_overflow_init(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(4), (32 / (8u))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (2)-1u);
   __vcop_pblock_init32(pblock, __offset+_PREG(6), (uchar *)pInput+2*8u*sizeof(*pInput)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pInput+2*8u*sizeof(*pInput)*2*1);
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(22), 4294967295);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), 0x8000000000);
   __offset += 24;
...
void vcop_fft_128_16ix16o_radix2_stage_4_overflow_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   ...
   __vcop_vloop(__vcop_compute(), 26u, 12u, 1u);
   __vcop_vinit(__vcop_sizeWU(), __vcop_once(), _PREG(22), _VREG(19));
   __vcop_vinit(__vcop_sizeW(), __vcop_once(), _PREG(24), _VREG(18));
   __vcop_vagen(_AGEN(1), _PREG(18), _PREG(19), _PREG(19), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(18), _PREG(18), _PREG(20), _PREG(0));
...
void vcop_fft_128_16ix16o_radix2_stage_4_overflow(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_radix2_stage_4_overflow_init(pInput, pScratch1, pScratch2, pOutput, pScaleFactor, numValidBits, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_radix2_stage_4_overflow);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_radix2_stage_4_overflow_vloops(__pblock_vcop_fft_128_16ix16o_radix2_stage_4_overflow);
...
void vcop_fft_128_16ix16o_radix2_stage_4_overflow_custom(
   __vptr_int16 pInput,
   __vptr_int32 pScratch1,
   __vptr_int32 pScratch2,
   __vptr_int16 pOutput,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_radix2_stage_4_overflow_init(pInput, pScratch1, pScratch2, pOutput, pScaleFactor, numValidBits, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_radix2_stage_4_overflow_vloops(pblock);
