...
#pragma DATA_SECTION(__pblock_vcop_gauss5x5PyramidKernel_16_horiz, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_gauss5x5PyramidKernel_16_horiz, __ALIGNOF__(int));
unsigned short __pblock_vcop_gauss5x5PyramidKernel_16_horiz[22];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(10), _AGEN(0), _VPAIR(20,21), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(12), _AGEN(0), _VPAIR(22,23), __vcop_alws());
   ...
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeHU(), __vcop_npt(), __vcop_alws(), _VREG(26), _PREG(14), _AGEN(1), _PREG(6));
   __vcop_vloop_end(1u);
   ...
   unsigned short outPitch)
{
   ...
   vcop_gauss5x5PyramidKernel_16_horiz_init(pIn, pOut, width, height, inPitch, outPitch, __pblock_vcop_gauss5x5PyramidKernel_16_horiz);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_gauss5x5PyramidKernel_16_horiz_vloops(__pblock_vcop_gauss5x5PyramidKernel_16_horiz);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_gauss5x5PyramidKernel_16_horiz_init(pIn, pOut, width, height, inPitch, outPitch, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_gauss5x5PyramidKernel_16_horiz_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_gauss5x5PyramidKernel_16_vert, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_gauss5x5PyramidKernel_16_vert, __ALIGNOF__(int));
unsigned short __pblock_vcop_gauss5x5PyramidKernel_16_vert[24];
   ...
   unsigned short pblock[])
{
   ...
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(8), _AGEN(0), _VPAIR(22,23), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(10), _AGEN(0), _VPAIR(24,25), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(12), _AGEN(0), _VPAIR(26,27), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(14), _AGEN(0), _VPAIR(28,29), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_dintrlv(), _PREG(16), _AGEN(0), _VPAIR(30,31), __vcop_alws());
   ...
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeHU(), __vcop_intrlv(), __vcop_alws(), _VPAIR(22,23), _PREG(18), _AGEN(1), _PREG(6));
   __vcop_vloop_end(1u);
   ...
   unsigned short outPitch)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_gauss5x5PyramidKernel_16_vert_init(pIn, pOut, width, height, inPitch, outPitch, __pblock_vcop_gauss5x5PyramidKernel_16_vert);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_gauss5x5PyramidKernel_16_vert_vloops(__pblock_vcop_gauss5x5PyramidKernel_16_vert);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_gauss5x5PyramidKernel_16_vert_init(pIn, pOut, width, height, inPitch, outPitch, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_gauss5x5PyramidKernel_16_vert_vloops(pblock);
