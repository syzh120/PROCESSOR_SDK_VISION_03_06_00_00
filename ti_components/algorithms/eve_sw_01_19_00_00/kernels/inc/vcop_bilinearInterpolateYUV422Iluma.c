...
#pragma DATA_SECTION(__pblock_vcop_bilinearInterpolateYUV422Iluma, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_bilinearInterpolateYUV422Iluma, __ALIGNOF__(int));
unsigned short __pblock_vcop_bilinearInterpolateYUV422Iluma[68];

unsigned int vcop_bilinearInterpolateYUV422Iluma_param_count(void)
{
   return 68u;
}

unsigned int vcop_bilinearInterpolateYUV422Iluma_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_bilinearInterpolateYUV422Iluma_init(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(10), 0x0000000001);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)fracArray);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)scatterStoreArray);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)scratchPixel);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)scratchPixel+sizeof(*dst)*2*maxNumMappedPixels);
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(26), (2*8u*sizeof(*(scratchPixel+sizeof(*dst)*2*maxNumMappedPixels))));
...
void vcop_bilinearInterpolateYUV422Iluma_vloops(
   unsigned short pblock[])
{
   ...
   #pragma VCC_VREG("scatterStore", 36);
   #pragma VCC_VREG("temp1", 37);
   #pragma VCC_VREG("temp2", 38);
   #pragma VCC_VREG("xFrac", 39);
   #pragma VCC_VREG("yFrac", 40);
   ...
   __vcop_vloop(__vcop_compute(), 27u, 15u, 4u);
   __vcop_vinit(__vcop_sizeW(), __vcop_once(), _PREG(28), _VREG(17));
   __vcop_vinit(__vcop_sizeW(), __vcop_alws(), _PREG(30), _VREG(26));
   ...
   __vcop_vload(__vcop_sizeBU(), __vcop_npt(), _PREG(12), _AGEN(1), _VREG(29), __vcop_alws());
   __vcop_vload(__vcop_sizeHU(), __vcop_npt(), _PREG(14), _AGEN(3), _VREG(36), __vcop_alws());
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(16), _AGEN(2), _VPAIR(30,32), __vcop_alws());
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(18), _AGEN(2), _VPAIR(31,33), __vcop_alws());
   __vcop_vand(_VREG(29), _VREG(26), _VREG(39));
   __vcop_vshf(_VREG(29), _VREG(28), _VREG(40));
   __vcop_vmpy(_VREG(39), _VREG(32), _VREG(37), _PREG(0));
   __vcop_vmpy(_VREG(39), _VREG(33), _VREG(38), _PREG(0));
   __vcop_vsub(_VREG(17), _VREG(39), _VREG(34));
   __vcop_vsub(_VREG(17), _VREG(40), _VREG(35));
   __vcop_vmadd(_VREG(34), _VREG(30), _VREG(37), _PREG(0));
   __vcop_vmadd(_VREG(34), _VREG(31), _VREG(38), _PREG(0));
   __vcop_vmpy(_VREG(35), _VREG(37), _VREG(37), _PREG(0));
   __vcop_vmpy(_VREG(40), _VREG(38), _VREG(38), _PREG(0));
   __vcop_vadd(_VREG(37), _VREG(38), _VREG(37));
   __vcop_vshf(_VREG(36), _VREG(27), _VREG(36));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeBU(), __vcop_sdda(_VREG(36)), __vcop_alws(), _VREG(37), _PREG(20), _AGEN(4), _PREG(6));
   __vcop_vloop_end(4u);

}

void vcop_bilinearInterpolateYUV422Iluma(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short maxNumMappedPixels,
   unsigned short numMappedPixels,
   ...
   long sat_low_set)
{
   ...
   vcop_bilinearInterpolateYUV422Iluma_init(src, dst, maxNumMappedPixels, numMappedPixels, tluIndexArray, fracArray, scatterStoreArray, scratchLUT, scratchPixel, stride_ptr, mnQShift, oQShift, qScale, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, __pblock_vcop_bilinearInterpolateYUV422Iluma);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolateYUV422Iluma_vloops(__pblock_vcop_bilinearInterpolateYUV422Iluma);
...
void vcop_bilinearInterpolateYUV422Iluma_custom(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short maxNumMappedPixels,
   unsigned short numMappedPixels,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_bilinearInterpolateYUV422Iluma_init(src, dst, maxNumMappedPixels, numMappedPixels, tluIndexArray, fracArray, scatterStoreArray, scratchLUT, scratchPixel, stride_ptr, mnQShift, oQShift, qScale, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolateYUV422Iluma_vloops(pblock);
