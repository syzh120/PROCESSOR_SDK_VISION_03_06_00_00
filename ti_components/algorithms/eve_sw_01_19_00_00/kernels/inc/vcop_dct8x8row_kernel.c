...
#pragma DATA_SECTION(__pblock_vcop_dct8x8_OddEven_row_int_int, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_dct8x8_OddEven_row_int_int, __ALIGNOF__(int));
unsigned short __pblock_vcop_dct8x8_OddEven_row_int_int[56];

unsigned int vcop_dct8x8_OddEven_row_int_int_param_count(void)
{
   return 56u;
}

unsigned int vcop_dct8x8_OddEven_row_int_int_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_dct8x8_OddEven_row_int_int_init(
   __vptr_int16 in,
...
void vcop_dct8x8_OddEven_row_int_int_vloops(
   unsigned short pblock[])
{
   ...
   int rnd_shift)
{
   ...
   vcop_dct8x8_OddEven_row_int_int_init(in, f_ignore, out, w_input, h_input, w_out, h_out, HBLKS, VBLKS, type_input, type_coeff, type_output, rnd_shift, __pblock_vcop_dct8x8_OddEven_row_int_int);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_dct8x8_OddEven_row_int_int_vloops(__pblock_vcop_dct8x8_OddEven_row_int_int);
...
void vcop_dct8x8_OddEven_row_int_int_custom(
   __vptr_int16 in,
   __vptr_int16 f_ignore,
   __vptr_int16 out,
   int w_input,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_dct8x8_OddEven_row_int_int_init(in, f_ignore, out, w_input, h_input, w_out, h_out, HBLKS, VBLKS, type_input, type_coeff, type_output, rnd_shift, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_dct8x8_OddEven_row_int_int_vloops(pblock);
