...
#pragma DATA_SECTION(__pblock_vcop_vec_bin_image_dilate_square, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_vec_bin_image_dilate_square, __ALIGNOF__(int));
unsigned short __pblock_vcop_vec_bin_image_dilate_square[28];
   ...
   unsigned short pblock[])
{
   ...
   #pragma VCC_VREG("r", 26);
   #pragma VCC_VREG("t1", 27);
   #pragma VCC_VREG("t2", 28);
   #pragma VCC_VREG("t3", 29);
   #pragma VCC_VREG("t4", 30);
   ...
   __vcop_vor3(_VREG(22), _VREG(24), _VREG(20));
   __vcop_vor3(_VREG(21), _VREG(25), _VREG(23));
   __vcop_vshf(_VREG(20), _VREG(17), _VREG(27));
   __vcop_vshf(_VREG(23), _VREG(18), _VREG(28));
   __vcop_vor3(_VREG(28), _VREG(20), _VREG(27));
   __vcop_vshf(_VREG(20), _VREG(16), _VREG(29));
   __vcop_vshf(_VREG(23), _VREG(19), _VREG(30));
   __vcop_vor3(_VREG(29), _VREG(30), _VREG(27));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeWU(), __vcop_npt(), __vcop_alws(), _VREG(27), _PREG(22), _AGEN(0), _PREG(0));
   __vcop_vloop_end(1u);
   ...
   unsigned short height)
{
   ...
   vcop_vec_bin_image_dilate_square_init(pIn, out, cols, pitch, height, __pblock_vcop_vec_bin_image_dilate_square);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_vec_bin_image_dilate_square_vloops(__pblock_vcop_vec_bin_image_dilate_square);
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_vec_bin_image_dilate_square_init(pIn, out, cols, pitch, height, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_vec_bin_image_dilate_square_vloops(pblock);
