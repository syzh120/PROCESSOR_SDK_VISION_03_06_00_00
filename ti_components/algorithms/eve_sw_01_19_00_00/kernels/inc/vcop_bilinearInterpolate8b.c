...
#pragma DATA_SECTION(__pblock_vcop_bilinearInterpolate8b, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_bilinearInterpolate8b, __ALIGNOF__(int));
unsigned short __pblock_vcop_bilinearInterpolate8b[66];

unsigned int vcop_bilinearInterpolate8b_param_count(void)
{
   return 66u;
}

unsigned int vcop_bilinearInterpolate8b_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_bilinearInterpolate8b_init(
   __vptr_uint8 src,
   __vptr_uint8 dst,
...
void vcop_bilinearInterpolate8b_vloops(
   unsigned short pblock[])
{
   ...
   __vcop_vtbload(__vcop_sizeBU(), __vcop_tableinfo(1, 2), _PREG(12), _AGEN(1), _VREG(23), _VREG(22), _PREG(0), __vcop_alws());
   ...
   __vcop_vtbload(__vcop_sizeBU(), __vcop_tableinfo(1, 2), _PREG(12), _AGEN(1), _VREG(25), _VREG(24), _PREG(0), __vcop_alws());
   ...
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(14), _AGEN(2), _VPAIR(29,31), __vcop_alws());
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(16), _AGEN(2), _VPAIR(30,32), __vcop_alws());
   ...
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeBU(), __vcop_sdda(_VREG(35)), __vcop_alws(), _VREG(36), _PREG(18), _AGEN(4), _PREG(6));
   __vcop_vloop_end(4u);

}

void vcop_bilinearInterpolate8b(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short maxNumMappedPixels,
   unsigned short numMappedPixels,
   ...
   long sat_low_set)
{
   ...
   vcop_bilinearInterpolate8b_init(src, dst, maxNumMappedPixels, numMappedPixels, tluIndexArray, fracArray, scatterStoreArray, scratchLUT, scratchPixel, stride_ptr, mnQShift, oQShift, qScale, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, __pblock_vcop_bilinearInterpolate8b);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolate8b_vloops(__pblock_vcop_bilinearInterpolate8b);
...
void vcop_bilinearInterpolate8b_custom(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short maxNumMappedPixels,
   unsigned short numMappedPixels,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_bilinearInterpolate8b_init(src, dst, maxNumMappedPixels, numMappedPixels, tluIndexArray, fracArray, scatterStoreArray, scratchLUT, scratchPixel, stride_ptr, mnQShift, oQShift, qScale, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolate8b_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_bilinearInterpolate8b_highSpeed, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_bilinearInterpolate8b_highSpeed, __ALIGNOF__(int));
unsigned short __pblock_vcop_bilinearInterpolate8b_highSpeed[52];

unsigned int vcop_bilinearInterpolate8b_highSpeed_param_count(void)
{
   return 52u;
}

unsigned int vcop_bilinearInterpolate8b_highSpeed_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_bilinearInterpolate8b_highSpeed_init(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   ...
   unsigned short pblock[])
{
   ...
   /* Loop 3 PREGS */
   const int preg_ref2 = _PREG(18);

   __vcop_pblock_init16(pblock, __offset+_PREG(2), 0);
   __vcop_pblock_init16(pblock, __offset+_PREG(3), 0);
   __vcop_pblock_init16(pblock, __offset+_PREG(4), 0);
   __vcop_pblock_init16(pblock, __offset+_PREG(5), ((((outputBlockSize) + (8u)-1U) & ~((8u)-1U))/(8u))-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(6), __vcop_store_round_sat(SM_4PARAM,preg_ref2,RM_ROUND,mnQShift+oQShift));
   __vcop_pblock_init16(pblock, __offset+_PREG(7), 8);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), -4);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)fracArray);
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)dst);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(18), sat_high,sat_high_set,sat_low,sat_low_set);
   __vcop_pblock_init16(pblock, __offset+_PREG(22), 32);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), qScale);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), 0x000000000F);
   __offset += 26;

   return 52u;
}

void vcop_bilinearInterpolate8b_highSpeed_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   ...
   __vcop_vload(__vcop_sizeHU(), __vcop_1pt(), _PREG(10), _AGEN(0), _VREG(24), __vcop_alws());
   __vcop_vtbload(__vcop_sizeBU(), __vcop_tableinfo(2, 2), _PREG(12), _AGEN(1), _VREG(24), _VREG(23), _PREG(0), __vcop_alws());
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeBU(), __vcop_npt(), __vcop_alws(), _VREG(23), _PREG(6), _AGEN(2), _PREG(0));
   __vcop_vloop_end(2u);

   /* VLOOP 3 Start */

   /* VLOOP Local Vector Registers */
   #pragma VCC_VREG("Vmaskx", 25);
   #pragma VCC_VREG("Vmasky", 26);
   #pragma VCC_VREG("Vshiftx", 27);
   #pragma VCC_VREG("Vshifty", 28);
   #pragma VCC_VREG("fracMap", 29);
   #pragma VCC_VREG("pix00", 30);
   #pragma VCC_VREG("pix01", 31);
   #pragma VCC_VREG("pix10", 32);
   #pragma VCC_VREG("pix11", 33);
   ...
   __vcop_vinit(__vcop_sizeW(), __vcop_once(), _PREG(24), _VREG(22));
   __vcop_vinit(__vcop_sizeW(), __vcop_alws(), _PREG(26), _VREG(25));
   __vcop_vinit(__vcop_sizeW(), __vcop_alws(), _PREG(8), _VREG(28));
   __vcop_vagen(_AGEN(1), _PREG(7), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(2), _PREG(22), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(3), _PREG(7), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vload(__vcop_sizeBU(), __vcop_npt(), _PREG(10), _AGEN(1), _VREG(29), __vcop_alws());
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(12), _AGEN(2), _VPAIR(18,19), __vcop_alws());
   __vcop_vload(__vcop_sizeBU(), __vcop_dintrlv(), _PREG(14), _AGEN(2), _VPAIR(20,21), __vcop_alws());
   __vcop_vmove(_VREG(18), _VREG(30));
   __vcop_vmove(_VREG(20), _VREG(31));
   __vcop_vdintrlv(_VREG(30), _VREG(31));
   __vcop_vmove(_VREG(19), _VREG(32));
   __vcop_vmove(_VREG(21), _VREG(33));
   __vcop_vdintrlv(_VREG(32), _VREG(33));
   __vcop_vand(_VREG(29), _VREG(25), _VREG(38));
   __vcop_vshf(_VREG(29), _VREG(28), _VREG(39));
   __vcop_vmpy(_VREG(38), _VREG(32), _VREG(36), _PREG(0));
   __vcop_vmpy(_VREG(38), _VREG(33), _VREG(37), _PREG(0));
   __vcop_vsub(_VREG(22), _VREG(38), _VREG(34));
   __vcop_vsub(_VREG(22), _VREG(39), _VREG(35));
   __vcop_vmadd(_VREG(34), _VREG(30), _VREG(36), _PREG(0));
   __vcop_vmadd(_VREG(34), _VREG(31), _VREG(37), _PREG(0));
   __vcop_vmpy(_VREG(35), _VREG(36), _VREG(36), _PREG(0));
   __vcop_vmpy(_VREG(39), _VREG(37), _VREG(37), _PREG(0));
   __vcop_vadd(_VREG(36), _VREG(37), _VREG(36));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeBU(), __vcop_npt(), __vcop_alws(), _VREG(36), _PREG(16), _AGEN(3), _PREG(6));
   __vcop_vloop_end(3u);

}

void vcop_bilinearInterpolate8b_highSpeed(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short outputBlockSize,
   __vptr_uint16 tluIndexArray,
   ...
   long sat_low_set)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_bilinearInterpolate8b_highSpeed_init(src, dst, outputBlockSize, tluIndexArray, fracArray, scratch, scratchHbuf, stride, inSize, inLUT, mnQShift, oQShift, qScale, mult, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, __pblock_vcop_bilinearInterpolate8b_highSpeed);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolate8b_highSpeed_vloops(__pblock_vcop_bilinearInterpolate8b_highSpeed);
...
void vcop_bilinearInterpolate8b_highSpeed_custom(
   __vptr_uint8 src,
   __vptr_uint8 dst,
   unsigned short outputBlockSize,
   __vptr_uint16 tluIndexArray,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_bilinearInterpolate8b_highSpeed_init(src, dst, outputBlockSize, tluIndexArray, fracArray, scratch, scratchHbuf, stride, inSize, inLUT, mnQShift, oQShift, qScale, mult, rightShift, sat_high, sat_high_set, sat_low, sat_low_set, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_bilinearInterpolate8b_highSpeed_vloops(pblock);
