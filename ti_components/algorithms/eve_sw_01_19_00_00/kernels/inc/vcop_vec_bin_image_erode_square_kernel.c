...
#pragma DATA_SECTION(__pblock_vcop_vec_bin_image_erode_square, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_vec_bin_image_erode_square, __ALIGNOF__(int));
unsigned short __pblock_vcop_vec_bin_image_erode_square[28];

unsigned int vcop_vec_bin_image_erode_square_param_count(void)
{
   return 28u;
}

unsigned int vcop_vec_bin_image_erode_square_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_vec_bin_image_erode_square_init(
   __vptr_uint32 pIn,
   __vptr_uint32 out,
   unsigned short cols,
...
void vcop_vec_bin_image_erode_square_vloops(
   unsigned short pblock[])
{
   ...
   #pragma VCC_VREG("t5", 34);
   #pragma VCC_VREG("t6", 35);
   ...
   __vcop_vloop(__vcop_compute(), 29u, 14u, 1u);
   ...
   __vcop_vshf(_VREG(24), _VREG(18), _VREG(21));
   __vcop_vshfor(_VREG(25), _VREG(16), _VREG(20));
   __vcop_vshfor(_VREG(25), _VREG(17), _VREG(21));
   __vcop_vshf(_VREG(26), _VREG(19), _VREG(22));
   __vcop_vand3(_VREG(24), _VREG(26), _VREG(20));
   __vcop_vshf(_VREG(26), _VREG(18), _VREG(23));
   __vcop_vand3(_VREG(28), _VREG(21), _VREG(20));
   __vcop_vshfor(_VREG(27), _VREG(16), _VREG(22));
   __vcop_vshfor(_VREG(27), _VREG(17), _VREG(23));
   __vcop_vshf(_VREG(28), _VREG(19), _VREG(34));
   __vcop_vshf(_VREG(28), _VREG(18), _VREG(35));
   __vcop_vand3(_VREG(22), _VREG(23), _VREG(20));
   __vcop_vshfor(_VREG(29), _VREG(16), _VREG(34));
   __vcop_vshfor(_VREG(29), _VREG(17), _VREG(35));
   __vcop_vand3(_VREG(20), _VREG(35), _VREG(34));
   __vcop_vstore(__vcop_unconditional(), __vcop_sizeWU(), __vcop_npt(), __vcop_alws(), _VREG(34), _PREG(22), _AGEN(0), _PREG(0));
   __vcop_vloop_end(1u);

}

void vcop_vec_bin_image_erode_square(
   __vptr_uint32 pIn,
   __vptr_uint32 out,
   unsigned short cols,
   unsigned short pitch,
   unsigned short height)
{
   ...
   vcop_vec_bin_image_erode_square_init(pIn, out, cols, pitch, height, __pblock_vcop_vec_bin_image_erode_square);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_vec_bin_image_erode_square_vloops(__pblock_vcop_vec_bin_image_erode_square);
...
void vcop_vec_bin_image_erode_square_custom(
   __vptr_uint32 pIn,
   __vptr_uint32 out,
   unsigned short cols,
   unsigned short pitch,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_vec_bin_image_erode_square_init(pIn, out, cols, pitch, height, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_vec_bin_image_erode_square_vloops(pblock);
