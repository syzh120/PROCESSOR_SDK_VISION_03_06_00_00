...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_1, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_1, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_1[38];

unsigned int vcop_fft_128_16ix16o_stage_1_param_count(void)
{
   return 38u;
}

unsigned int vcop_fft_128_16ix16o_stage_1_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_1_init(
   __vptr_int16 pInput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(32), (pitch) -(sizeof(*pInput)*2*32*4)*(((1))-1u) -(sizeof(*pInput)*2*8u)*(((32)/(8u))-1u));
...
void vcop_fft_128_16ix16o_stage_1_vloops(
   unsigned short pblock[])
{
...
void vcop_fft_128_16ix16o_stage_1(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short pitch,
   ...
   unsigned short saturationLimit)
{
   ...
   vcop_fft_128_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_1);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_1_vloops(__pblock_vcop_fft_128_16ix16o_stage_1);
...
void vcop_fft_128_16ix16o_stage_1_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short pitch,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_1_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_2, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_2, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_2[48];

unsigned int vcop_fft_128_16ix16o_stage_2_param_count(void)
{
   return 48u;
}

unsigned int vcop_fft_128_16ix16o_stage_2_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_2_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(41), (pitch) -((8*4)*sizeof(*pInput)*2)*(((4))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(42), 4);
   __vcop_pblock_init16(pblock, __offset+_PREG(43), 532);
...
void vcop_fft_128_16ix16o_stage_2_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
...
void vcop_fft_128_16ix16o_stage_2(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   __vptr_uint16 pScatterOffset,
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_2);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_2_vloops(__pblock_vcop_fft_128_16ix16o_stage_2);
...
void vcop_fft_128_16ix16o_stage_2_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   __vptr_uint16 pScatterOffset,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_2_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_stage_3, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_stage_3, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_stage_3[40];

unsigned int vcop_fft_128_16ix16o_stage_3_param_count(void)
{
   return 40u;
}

unsigned int vcop_fft_128_16ix16o_stage_3_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_stage_3_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short numOfLines,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+2*(2*8u)*sizeof(*pOutput)*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 68);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), -36);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), 444);
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 64);
   __vcop_pblock_init16(pblock, __offset+_PREG(34), -32);
   __vcop_pblock_init16(pblock, __offset+_PREG(35), 416);
...
void vcop_fft_128_16ix16o_stage_3_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
...
void vcop_fft_128_16ix16o_stage_3(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short numOfLines,
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_stage_3);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_3_vloops(__pblock_vcop_fft_128_16ix16o_stage_3);
...
void vcop_fft_128_16ix16o_stage_3_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short numOfLines,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_stage_3_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_128_16ix16o_radix2_stage_4, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_128_16ix16o_radix2_stage_4, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_128_16ix16o_radix2_stage_4[20];

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_param_count(void)
{
   return 20u;
}

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_128_16ix16o_radix2_stage_4_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   unsigned short numOfLines,
   unsigned short scale,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pOutput+2*8u*sizeof(*pOutput)*2*4*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(10), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pOutput+2*8u*sizeof(*pOutput)*2*4*1);
   __vcop_pblock_init16(pblock, __offset+_PREG(16), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(17), 288);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pInput+2*8u*sizeof(*pInput)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pInput+2*8u*sizeof(*pInput)*2*1);
   __offset += 20;

   return 20u;
}

void vcop_fft_128_16ix16o_radix2_stage_4_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   ...
   __vcop_vloop(__vcop_compute(), 13u, 10u, 1u);
   __vcop_vagen(_AGEN(0), _PREG(7), _PREG(16), _PREG(16), _PREG(0));
   __vcop_vagen(_AGEN(1), _PREG(7), _PREG(7), _PREG(17), _PREG(0));
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(18), _AGEN(0), _VPAIR(16,20), __vcop_alws());
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(20), _AGEN(0), _VPAIR(19,23), __vcop_alws());
...
void vcop_fft_128_16ix16o_radix2_stage_4(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   unsigned short numOfLines,
   unsigned short scale,
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_radix2_stage_4_init(pInput, pOutput, numOfLines, scale, saturationLimit, __pblock_vcop_fft_128_16ix16o_radix2_stage_4);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_radix2_stage_4_vloops(__pblock_vcop_fft_128_16ix16o_radix2_stage_4);
...
void vcop_fft_128_16ix16o_radix2_stage_4_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   unsigned short numOfLines,
   unsigned short scale,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_128_16ix16o_radix2_stage_4_init(pInput, pOutput, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_128_16ix16o_radix2_stage_4_vloops(pblock);
