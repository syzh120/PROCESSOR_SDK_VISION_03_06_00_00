...
#pragma DATA_SECTION(__pblock_vcop_fft_1024_16ix16o_stage_1, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_1024_16ix16o_stage_1, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_1024_16ix16o_stage_1[38];

unsigned int vcop_fft_1024_16ix16o_stage_1_param_count(void)
{
   return 38u;
}

unsigned int vcop_fft_1024_16ix16o_stage_1_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_1024_16ix16o_stage_1_init(
   __vptr_int16 pInput,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pInput+256*sizeof(*pInput)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pInput+256*sizeof(*pInput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pInput+256*sizeof(*pInput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pInput+256*sizeof(*pInput)*2*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+256*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+256*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+256*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+256*sizeof(*pOutput)*2*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 32);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), 3104);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), (pitch) -(sizeof(*pInput)*2*256*4)*(((1))-1u) -(sizeof(*pInput)*2*8u)*(((256)/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(34), -2976);
...
void vcop_fft_1024_16ix16o_stage_1_vloops(
   unsigned short pblock[])
{
   ...
   unsigned short saturationLimit)
{
   ...
   vcop_fft_1024_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_1024_16ix16o_stage_1);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_1_vloops(__pblock_vcop_fft_1024_16ix16o_stage_1);
...
void vcop_fft_1024_16ix16o_stage_1_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short pitch,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_1_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_1_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_1024_16ix16o_stage_2, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_1024_16ix16o_stage_2, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_1024_16ix16o_stage_2[38];

unsigned int vcop_fft_1024_16ix16o_stage_2_param_count(void)
{
   return 38u;
}

unsigned int vcop_fft_1024_16ix16o_stage_2_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_1024_16ix16o_stage_2_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short pitch,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(32), (pitch) -(sizeof(*pInput)*2*64*4)*(((4))-1u) -(sizeof(*pInput)*2*8u)*(((64)/(8u))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(33), 96);
...
void vcop_fft_1024_16ix16o_stage_2_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_1024_16ix16o_stage_2);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_2_vloops(__pblock_vcop_fft_1024_16ix16o_stage_2);
...
void vcop_fft_1024_16ix16o_stage_2_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short pitch,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_2_init(pInput, pOutput, pTwiddleFactor, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_2_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_1024_16ix16o_stage_3, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_1024_16ix16o_stage_3, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_1024_16ix16o_stage_3[52];

unsigned int vcop_fft_1024_16ix16o_stage_3_param_count(void)
{
   return 52u;
}

unsigned int vcop_fft_1024_16ix16o_stage_3_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_1024_16ix16o_stage_3_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(7), __vcop_store_round_sat(SM_4PARAM,preg_ref3,RM_ROUND,scale + 15));
   ...
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pOutput+16*sizeof(*pOutput)*2*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(22), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+16*sizeof(*pOutput)*2*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+16*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pOutput+16*sizeof(*pOutput)*2*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(32), (uchar *)pOutput+16*sizeof(*pOutput)*2*0+sizeof(*pOutput));
   __vcop_pblock_init32(pblock, __offset+_PREG(34), (uchar *)pOutput+16*sizeof(*pOutput)*2*1+sizeof(*pOutput));
   __vcop_pblock_init32(pblock, __offset+_PREG(36), (uchar *)pOutput+16*sizeof(*pOutput)*2*2+sizeof(*pOutput));
   __vcop_pblock_init32(pblock, __offset+_PREG(38), (uchar *)pOutput+16*sizeof(*pOutput)*2*3+sizeof(*pOutput));
   __vcop_pblock_init16(pblock, __offset+_PREG(40), 32);
   __vcop_pblock_init16(pblock, __offset+_PREG(41), 224);
   __vcop_pblock_init16(pblock, __offset+_PREG(42), (pitch) -(4*(16*4)*sizeof(*pInput)*2)*(((16) / 4)-1u) -((16*4)*sizeof(*pInput)*2)*((4)-1u) -(8u*sizeof(*pInput)*2)*((((16)/ (8u)))-1u));
   __vcop_pblock_init16(pblock, __offset+_PREG(43), 2080);
   __vcop_pblock_init16(pblock, __offset+_PREG(44), -2064);
   __vcop_pblock_init16(pblock, __offset+_PREG(45), -2124);
   __vcop_pblock_init16(pblock, __offset+_PREG(46), 2020);
   __vcop_pblock_init16(pblock, __offset+_PREG(47), 96);
   __vcop_pblock_init16(pblock, __offset+_PREG(48), -96);
   __vcop_pblock_init32(pblock, __offset+_PREG(50), (uchar *)pScatterOffset);
   __vcop_pblock_init32(pblock, __offset+_PREG(52), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*0);
   __offset += 52;

   return 52u;
}

void vcop_fft_1024_16ix16o_stage_3_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
   ...
   __vcop_vloop(__vcop_compute(), 57u, 26u, 1u);
   __vcop_vagen(_AGEN(0), _PREG(0), _PREG(0), _PREG(0), _PREG(0));
   __vcop_vagen(_AGEN(1), _PREG(40), _PREG(41), _PREG(41), _PREG(42));
   __vcop_vagen(_AGEN(2), _PREG(43), _PREG(44), _PREG(45), _PREG(46));
   __vcop_vagen(_AGEN(3), _PREG(47), _PREG(48), _PREG(48), _PREG(48));
   __vcop_vload(__vcop_sizeHU(), __vcop_npt(), _PREG(50), _AGEN(0), _VREG(22), __vcop_once());
   __vcop_vload(__vcop_sizeH(), __vcop_dintrlv(), _PREG(52), _AGEN(3), _VPAIR(19,16), __vcop_alws());
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, __pblock_vcop_fft_1024_16ix16o_stage_3);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_3_vloops(__pblock_vcop_fft_1024_16ix16o_stage_3);
...
void vcop_fft_1024_16ix16o_stage_3_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   __vptr_uint16 pScatterOffset,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_3_init(pInput, pOutput, pTwiddleFactor, pScatterOffset, pitch, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_3_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_1024_16ix16o_stage_4, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_1024_16ix16o_stage_4, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_1024_16ix16o_stage_4[40];

unsigned int vcop_fft_1024_16ix16o_stage_4_param_count(void)
{
   return 40u;
}

unsigned int vcop_fft_1024_16ix16o_stage_4_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_1024_16ix16o_stage_4_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short numOfLines,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(7), __vcop_store_round_sat(SM_4PARAM,preg_ref4,RM_ROUND,15 + scale));
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pTwiddleFactor+8*sizeof(*pTwiddleFactor)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pInput+4*(65*sizeof(*pOutput)*2)*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pInput+4*(65*sizeof(*pOutput)*2)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(14), (uchar *)pInput+4*(65*sizeof(*pOutput)*2)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(16), (uchar *)pInput+4*(65*sizeof(*pOutput)*2)*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+4*(64*sizeof(*pOutput)*2)*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(20), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(24), (uchar *)pOutput+4*(64*sizeof(*pOutput)*2)*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(26), (uchar *)pOutput+4*(64*sizeof(*pOutput)*2)*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(28), (uchar *)pOutput+4*(64*sizeof(*pOutput)*2)*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(30), 260);
   __vcop_pblock_init16(pblock, __offset+_PREG(31), -748);
   __vcop_pblock_init16(pblock, __offset+_PREG(32), 3156);
...
void vcop_fft_1024_16ix16o_stage_4_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_4_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, __pblock_vcop_fft_1024_16ix16o_stage_4);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_4_vloops(__pblock_vcop_fft_1024_16ix16o_stage_4);
...
void vcop_fft_1024_16ix16o_stage_4_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   __vptr_int16 pTwiddleFactor,
   unsigned short numOfLines,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_4_init(pInput, pOutput, pTwiddleFactor, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_4_vloops(pblock);
...
#pragma DATA_SECTION(__pblock_vcop_fft_1024_16ix16o_stage_5, ".vcop_parameter_block")
#pragma DATA_ALIGN(__pblock_vcop_fft_1024_16ix16o_stage_5, __ALIGNOF__(int));
unsigned short __pblock_vcop_fft_1024_16ix16o_stage_5[32];

unsigned int vcop_fft_1024_16ix16o_stage_5_param_count(void)
{
   return 32u;
}

unsigned int vcop_fft_1024_16ix16o_stage_5_ctrl_count(void)
{
   return 0u;
}

unsigned int vcop_fft_1024_16ix16o_stage_5_init(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   unsigned short numOfLines,
   unsigned short scale,
   ...
   unsigned short pblock[])
{
   ...
   __vcop_pblock_init16(pblock, __offset+_PREG(5), (4)-1u);
   __vcop_pblock_init16(pblock, __offset+_PREG(6), __vcop_store_round_sat(SM_4PARAM,preg_ref5,RM_ROUND,scale));
   __vcop_pblock_init16(pblock, __offset+_PREG(7), 1024);
   __vcop_pblock_init32(pblock, __offset+_PREG(8), (uchar *)pInput+64*sizeof(*pOutput)*2*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(10), (uchar *)pInput+64*sizeof(*pOutput)*2*3);
   __vcop_pblock_init32(pblock, __offset+_PREG(12), (uchar *)pOutput+64*sizeof(*pOutput)*2*4*0);
   __vcop_pblock_4param_init(pblock, __offset+_PREG(14), (saturationLimit - 1), (saturationLimit - 1), -saturationLimit, -saturationLimit);
   __vcop_pblock_init32(pblock, __offset+_PREG(18), (uchar *)pOutput+64*sizeof(*pOutput)*2*4*1);
   __vcop_pblock_init32(pblock, __offset+_PREG(20), (uchar *)pOutput+64*sizeof(*pOutput)*2*4*2);
   __vcop_pblock_init32(pblock, __offset+_PREG(22), (uchar *)pOutput+64*sizeof(*pOutput)*2*4*3);
   __vcop_pblock_init16(pblock, __offset+_PREG(24), -3040);
   __vcop_pblock_init16(pblock, __offset+_PREG(25), 800);
   __vcop_pblock_init16(pblock, __offset+_PREG(26), 256);
   __vcop_pblock_init16(pblock, __offset+_PREG(27), -736);
   __vcop_pblock_init16(pblock, __offset+_PREG(28), 3104);
   __vcop_pblock_init32(pblock, __offset+_PREG(30), (uchar *)pInput+64*sizeof(*pOutput)*2*0);
   __vcop_pblock_init32(pblock, __offset+_PREG(32), (uchar *)pInput+64*sizeof(*pOutput)*2*1);
   __offset += 32;

   return 32u;
}

void vcop_fft_1024_16ix16o_stage_5_vloops(
   unsigned short pblock[])
{
   /* Kernel-wide Vector Registers */
   #pragma VCC_VREG("VC1_76543210", 16);
   ...
   unsigned short saturationLimit)
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_5_init(pInput, pOutput, numOfLines, scale, saturationLimit, __pblock_vcop_fft_1024_16ix16o_stage_5);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_5_vloops(__pblock_vcop_fft_1024_16ix16o_stage_5);
...
void vcop_fft_1024_16ix16o_stage_5_custom(
   __vptr_int16 pInput,
   __vptr_int16 pOutput,
   unsigned short numOfLines,
   unsigned short scale,
   ...
   unsigned short pblock[])
{
   VCOP_BUF_SWITCH_SET(WBUF_SYST, IBUFHB_SYST, IBUFLB_SYST,
                   IBUFHA_SYST, IBUFLA_SYST);
   vcop_fft_1024_16ix16o_stage_5_init(pInput, pOutput, numOfLines, scale, saturationLimit, pblock);

   VCOP_BUF_SWITCH_SET(WBUF_VCOP, IBUFHB_VCOP, IBUFLB_VCOP,
                   IBUFHA_VCOP, IBUFLA_VCOP);
   vcop_fft_1024_16ix16o_stage_5_vloops(pblock);
