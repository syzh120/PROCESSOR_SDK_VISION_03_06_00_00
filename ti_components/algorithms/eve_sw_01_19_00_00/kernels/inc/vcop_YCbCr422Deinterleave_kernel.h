#ifndef _TI_vcop_YCbCr422Deinterleave_kernel_h_
#define _TI_vcop_YCbCr422Deinterleave_kernel_h_

/* Parameter Register Block */
extern unsigned short __pblock_vcop_YCbCr422_Deinterleave422_char[18];
...
#define PARAM_SIZE_vcop_YCbCr422_Deinterleave422_char ((unsigned int)18)
unsigned int vcop_YCbCr422_Deinterleave422_char_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_YCbCr422_Deinterleave422_char ((unsigned int)0)
unsigned int vcop_YCbCr422_Deinterleave422_char_ctrl_count(void);

/***********************************************************/
/* Parameter Register Block */
extern unsigned short __pblock_vcop_YCbCr422_Deinterleave422_short[18];
...
/* Parameter Register Count */
#define PARAM_SIZE_vcop_YCbCr422_Deinterleave422_short ((unsigned int)18)
unsigned int vcop_YCbCr422_Deinterleave422_short_param_count(void);
/* Internal Value Count */
#define CTRL_SIZE_vcop_YCbCr422_Deinterleave422_short ((unsigned int)0)
