...
#*******************************************************************************
#* FILE NAME: lib/vxlib_bamplugin.a86_64W.mk
#*
...
OBJDIR = ./package/lib/lib/vxlib_bamplugina86_64W
...
$(KERNELBAMC66HOSTCOBJS):lib\vxlib_bamplugin.a86_64W.mk
lib\vxlib_bamplugin.a86_64W.mk:
...
lib/vxlib_bamplugin.a86_64W : $(KERNELBAMC66HOSTCOBJS)
	@echo archiving $? into $@ ...
	@echo "-nologo -out:$@ $^">$@.cmd
	$(ARIN) @$@.cmd
