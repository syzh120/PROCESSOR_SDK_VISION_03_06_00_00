...
#*******************************************************************************
#* FILE NAME: lib/vxlib_bamplugin.a86l.mk
#*
...
OBJDIR = ./package/lib/lib/vxlib_bamplugina86l
...
KERNELBAMC66HOSTCFLAGS =  -DTMS320C66X -D_TMS320C6600 -D_HOST_BUILD -DCORE_DSP -DHOST_EMULATION
...
$(KERNELBAMC66HOSTCOBJS): $(OBJDIR)/%.$(OBJEXT): %.c
	...
	$(CC) $(KERNELBAMC66HOSTCFLAGS) $(INTERNALDEFS) $(INCS) -MMD -MF $@.dep -MT '$@' $< -o $@

#Create Empty rule for dependency
$(KERNELBAMC66HOSTCOBJS):lib\vxlib_bamplugin.a86l.mk
lib\vxlib_bamplugin.a86l.mk:
...
lib/vxlib_bamplugin.a86l : $(KERNELBAMC66HOSTCOBJS)
	@echo archiving $? into $@ ...
	@echo "-rscu $@ $^">$@.cmd
	$(ARIN) @$@.cmd
