...
OBJDIR = ./package/lib/lib/vxlibae66
...
$(KERNELC66COBJS):lib\vxlib.ae66.mk
lib\vxlib.ae66.mk:
...
lib/vxlib.ae66 : $(KERNELC66COBJS)
	@echo archiving $? into $@ ...
	@echo "rq $@ $?">$@.cmd
	$(ARIN) @$@.cmd
	if [ -f $(@D)/vxlib.lib  ]; then $(LIBINFO) -u -o=$(@D)/vxlib.lib $@; else $(LIBINFO) -o=$(@D)/vxlib.lib $@; fi;
