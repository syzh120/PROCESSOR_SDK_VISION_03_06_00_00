...
#*******************************************************************************
#* FILE NAME: lib/vxlib_cn.a86l.mk
#*
...
OBJDIR = ./package/lib/lib/vxlib_cna86l
...
$(KERNELC66HOSTCOBJS):lib\vxlib_cn.a86l.mk
lib\vxlib_cn.a86l.mk:
...
KERNELNATCC66HOSTCFLAGS =  -DTMS320C66X -D_TMS320C6600 -DLITTLE_ENDIAN_HOST -D_LITTLE_ENDIAN  -D_HOST_BUILD -Icommon/c6xsim
...
$(KERNELNATCC66HOSTCOBJS): $(OBJDIR)/%.$(OBJEXT): %.c
	-@echo cl86l $< ...
	if [ ! -d $(@D) ]; then $(MKDIR) $(@D) ; fi;
	$(CC) $(KERNELNATCC66HOSTCFLAGS) $(INTERNALDEFS) $(INCS) -MMD -MF $@.dep -MT '$@' $< -o $@

#Create Empty rule for dependency
$(KERNELNATCC66HOSTCOBJS):lib\vxlib_cn.a86l.mk
lib\vxlib_cn.a86l.mk:
...
lib/vxlib_cn.a86l : $(KERNELC66HOSTCOBJS) $(KERNELNATCC66HOSTCOBJS)
	@echo archiving $? into $@ ...
	@echo "-rscu $@ $^">$@.cmd
	$(ARIN) @$@.cmd
