...
#*******************************************************************************
#* FILE NAME: lib/vxlib.a86_64W.mk
#*
...
OBJDIR = ./package/lib/lib/vxliba86_64W
...
$(KERNELC66HOSTCOBJS):lib\vxlib.a86_64W.mk
lib\vxlib.a86_64W.mk:
...
lib/vxlib.a86_64W : $(KERNELC66HOSTCOBJS)
	@echo archiving $? into $@ ...
	@echo "-nologo -out:$@ $^">$@.cmd
	$(ARIN) @$@.cmd
