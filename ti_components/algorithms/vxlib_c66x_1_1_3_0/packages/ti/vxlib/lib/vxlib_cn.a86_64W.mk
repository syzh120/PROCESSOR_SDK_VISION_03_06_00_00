...
#*******************************************************************************
#* FILE NAME: lib/vxlib_cn.a86_64W.mk
#*
...
OBJDIR = ./package/lib/lib/vxlib_cna86_64W
...
$(KERNELC66HOSTCOBJS):lib\vxlib_cn.a86_64W.mk
lib\vxlib_cn.a86_64W.mk:
...
#Create Empty rule for dependency
$(KERNELNATCC66HOSTCOBJS):lib\vxlib_cn.a86_64W.mk
lib\vxlib_cn.a86_64W.mk:
...
lib/vxlib_cn.a86_64W : $(KERNELC66HOSTCOBJS) $(KERNELNATCC66HOSTCOBJS)
	@echo archiving $? into $@ ...
	@echo "-nologo -out:$@ $^">$@.cmd
	$(ARIN) @$@.cmd
