...
#*******************************************************************************
#* FILE NAME: lib/dsplib_cn.a66.mk
#*
...
OBJDIR = ./package/lib/lib/dsplib_cna66
...
$(KERNELC66COBJS):lib\dsplib_cn.a66.mk
lib\dsplib_cn.a66.mk:
...
lib/dsplib_cn.a66 : $(KERNELC66COBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
