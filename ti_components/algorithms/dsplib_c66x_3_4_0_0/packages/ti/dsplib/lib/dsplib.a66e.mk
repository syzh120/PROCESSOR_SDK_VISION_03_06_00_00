...
OBJDIR = ./package/lib/lib/dspliba66e
...
$(KERNELC66COBJS):lib\dsplib.a66e.mk
lib\dsplib.a66e.mk:
...
#Create Empty rule for dependency
$(KERNELC66SAOBJS):lib\dsplib.a66e.mk
lib\dsplib.a66e.mk:
...
lib/dsplib.a66e : $(KERNELC66COBJS) $(KERNELC66SAOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
