...
#include "../VLIB_kalmanFilter_2x4_Correct/VLIB_kalmanFilter_2x4_Correct_cn.h"

#include "VLIB_kalmanFilter_2x4_Predict.h"
#include "VLIB_kalmanFilter_2x4_Predict_cn.h"
#include "VLIB_kalmanFilter_2x4_Predict_idat.h"

/* VLIB_kalmanFilter_2x4_Predict_d:  Test Driver Routine */
void VLIB_kalmanFilter_2x4_Predict_d (uint8_t LevelOfFeedback)
{
    int32_t    tpi;  /* test parameter index */

    /* Test Parameters */
    kalmanFilter_2x4_Predict_testParams_t   *prm;

    kalmanFilter_2x4_Predict_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_kalmanFilter_2x4_Predict");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        if( Z && Z_buffer && Residual && Residual_cn && KF && KF_cn ) {
            ...
            for( i=0; i < prm[tpi].numMeasurements; i++ ) {
                ...
                VLIB_kalmanFilter_2x4_Correct_cn(KF, Z, Residual); // The natC version is used so that the code size doesn't get counted
...
main() {
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_kalmanFilter_2x4_Predict");
    } else {
        VLIB_kalmanFilter_2x4_Predict_d(0);
    }
}
#endif /* __ONESHOTTEST */

/* ======================================================================== */
/*  End of file:  VLIB_kalmanFilter_2x4_Predict_d.c                         */
/* ======================================================================== */
