...
#ifndef VLIB_WEIGHTED_HIST_ND_U16_IDAT_H

#define VLIB_WEIGHTED_HIST_ND_U16_IDAT_H
...
} weightedHistogram_nD_U16_testParams_t;

void weightedHistogram_nD_U16_getTestParams(weightedHistogram_nD_U16_testParams_t * *params, int32_t *numTests);

#endif /* define VLIB_WEIGHTED_HIST_ND_U16_IDAT_H */

/* ======================================================================== */
/*  End of file:  VLIB_weightedHistogram_nD_U16_idat.h                      */
/* ======================================================================== */
