...
static uint8_t    staticRefOut[] = { 149, 103, 109, 128 };

/* Expected image for constant array */
static uint8_t    staticRefOutConst[] = { 128, 128, 128, 128 };

static gradientH5x5Pyramid8_testParams_t    testParams[]=
{
    /********************************************
        {
           testPattern,
...
{
    *params = testParams;
    *numTests = sizeof(testParams) / sizeof(gradientH5x5Pyramid8_testParams_t);
}
