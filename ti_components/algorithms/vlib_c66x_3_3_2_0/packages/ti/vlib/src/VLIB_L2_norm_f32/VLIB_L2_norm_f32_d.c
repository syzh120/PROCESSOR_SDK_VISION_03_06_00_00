...
#include "VLIB_L2_norm_f32.h"
#include "VLIB_L2_norm_f32_cn.h"
#include "VLIB_L2_norm_f32_idat.h"

#define EPSILON 0.001       /* Degree of accuracy */

/* VLIB_L2_norm_f32_d:  Test Driver Routine */
void VLIB_L2_norm_f32_d (uint8_t LevelOfFeedback)
{
    int32_t    tpi;  /* test parameter index */

    /* Test Parameters */
    L2_norm_f32_testParams_t   *prm;

    L2_norm_f32_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_L2_norm_f32");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        VLIB_F32   *pData  = (VLIB_F32 *) VLIB_malloc(prm[tpi].len * sizeof(VLIB_F32));
        VLIB_D64    norm;
        VLIB_D64    norm_cn;
        ...
        if( pData ) {
            ...
            norm = VLIB_L2_norm_f32(pData, prm[tpi].len);
            VLIB_profile_stop();


            /* Test _cn kernel */
            VLIB_profile_start(vlib_KERNEL_CN);
            norm_cn = VLIB_L2_norm_f32(pData, prm[tpi].len);
            VLIB_profile_stop();
...
main() {
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_L2_norm_f32");
    } else {
        VLIB_L2_norm_f32_d(0);
    }
}
#endif /* __ONESHOTTEST */

/* ======================================================================== */
/*  End of file:  VLIB_L2_norm_f32_d.c                                      */
/* ======================================================================== */
