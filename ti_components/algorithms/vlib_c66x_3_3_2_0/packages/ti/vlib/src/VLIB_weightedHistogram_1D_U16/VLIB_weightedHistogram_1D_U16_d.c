...
#include "VLIB_weightedHistogram_1D_U16_cn.h"
#include "VLIB_weightedHistogram_1D_U16_idat.h"

#include "../VLIB_histogram_1D_Init_U16/VLIB_histogram_1D_Init_U16_cn.h"

/* VLIB_weightedHistogram_1D_U16_d:  Test Driver Routine */
void VLIB_weightedHistogram_1D_U16_d (uint8_t LevelOfFeedback)
{
    int32_t    tpi;  /* test parameter index */

    /* Test Parameters */
    weightedHistogram_1D_U16_testParams_t   *prm;

    weightedHistogram_1D_U16_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_weightedHistogram_1D_U16");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        if( binEdges && histArray && binWeight && X && H && H_cn && H1 ) {
            ...
            VLIB_weightedHistogram_1D_U16(X, prm[tpi].numX, prm[tpi].numBins, binWeight, histArray, H1, H);
            VLIB_profile_stop();
            ...
            VLIB_weightedHistogram_1D_U16_cn(X, prm[tpi].numX, prm[tpi].numBins, binWeight, histArray, H1, H_cn);
            VLIB_profile_stop();
...
main() {
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_weightedHistogram_1D_U16");
    } else {
        VLIB_weightedHistogram_1D_U16_d(0);
    }
}
#endif /* __ONESHOTTEST */

/* ======================================================================== */
/*  End of file:  VLIB_weightedHistogram_1D_U16_d.c                         */
/* ======================================================================== */
