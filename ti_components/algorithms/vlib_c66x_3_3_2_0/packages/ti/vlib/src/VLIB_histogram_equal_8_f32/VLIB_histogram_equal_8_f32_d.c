...
#include "VLIB_histogram_equal_8_f32.h"
#include "VLIB_histogram_equal_8_f32_cn.h"
#include "VLIB_histogram_equal_8_f32_idat.h"

/* VLIB_histogram_equal_8_d:  Test Driver Routine */
void VLIB_histogram_equal_8_f32_d(uint8_t LevelOfFeedback)
{
    int32_t    tpi;  /* test parameter index */

    /* Test Parameters */
    histogram_equal_8_f32_testParams_t   *prm;

    histogram_equal_8_f32_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_histogram_equal_8_f32");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        if( image && t_hist && histeq_image && histeq_image_cn ) {
            ...
            VLIB_histogram_equal_8_f32(image, prm[tpi].n, t_hist, histeq_image);
            VLIB_profile_stop();
            ...
            VLIB_histogram_equal_8_f32_cn(image, prm[tpi].n, t_hist, histeq_image_cn);
            VLIB_profile_stop();
...
main() {
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_histogram_equal_8_f32");
    } else {
        VLIB_histogram_equal_8_f32_d(0);
    }
}
#endif /* __ONESHOTTEST */

/* ======================================================================== */
/*  End of file:  VLIB_histogram_equal_8_f32_d.c                            */
/* ======================================================================== */
