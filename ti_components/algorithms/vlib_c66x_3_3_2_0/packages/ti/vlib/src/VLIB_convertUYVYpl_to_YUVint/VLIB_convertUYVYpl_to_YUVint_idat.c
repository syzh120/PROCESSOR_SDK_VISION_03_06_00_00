...
static UYVYpl_to_YUVint_testParams_t    testParams[]=
{
    /********************************************
        {
           testPattern,
           *staticInY, *staticInCr, *staticInCb, *staticOutYC
           width, pitch, height
        },
    *********************************************/
    /* MODE 1: pitch == width*/
    {
        STATIC,
        staticRefInY, staticRefInCr, staticRefInCb, staticRefOutYC,
        16, 16, 2
    },
    {
        RANDOM,
...
{
    *params = testParams;
    *numTests = sizeof(testParams) / sizeof(UYVYpl_to_YUVint_testParams_t);
}
