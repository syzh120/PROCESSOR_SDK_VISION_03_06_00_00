...
static histogram_1D_U16_testParams_t    testParams[]=
{
    /********************************************
        {
           testPattern,
    ...
    *********************************************/
    ...
    },
    {
        RANDOM,
        binEdges4, NULL, NULL,
        4096, sizeof(binEdges4) / sizeof(binEdges4[0]), 3, 512
    }
};
...
{
    *params = testParams;
    *numTests = sizeof(testParams) / sizeof(histogram_1D_U16_testParams_t);
}
