...
#include "VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile.h"
#include "VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn.h"
#include "VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_idat.h"

/* VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_d:  Test Driver Routine */
void VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_d(uint8_t LevelOfFeedback)
{
    ...
    /* Test Parameters */
    VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_testParams_t   *prm;

    VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        if( sInChannel.data && sWeights.data && sBias.data && sOutChannel.data && sOutChannel_cn.data ) {
            ...
            VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile(&sInChannel, &sWeights, &sBias, &sOutChannel, shiftQ, coeffQ);
            VLIB_profile_stop();


            /* Test _cn kernel */
            VLIB_profile_start(vlib_KERNEL_CN);
            VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn(&sInChannel, &sWeights, &sBias, &sOutChannel_cn, shiftQ, coeffQ);
            VLIB_profile_stop();
...
{
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile");
    } else {
        VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_d(0);
    }
    return (0);
}
...
/* ======================================================================== */
/*  End of file:  VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_d.c               */
/* ======================================================================== */
