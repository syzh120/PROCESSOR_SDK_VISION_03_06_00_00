...
**+--------------------------------------------------------------------------+**
*******************************************************************************/
#ifndef VLIB_CONV_I16S_C16S_O32S_5X5_SKIP2_TILE_CN_H_
#define VLIB_CONV_I16S_C16S_O32S_5X5_SKIP2_TILE_CN_H_ 1

#include "../common/VLIB_types.h"
#include "../common/VLIB_tiler.h"

/** @defgroup VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn */
/** @ingroup  VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn */
/* @{ */
 ...
 *
 * @par Algorithm:
 * VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn.c is the natural C equivalent of the optimized
 * intrinsics code.
 *
 * @par Assumptions:
...
void VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn(sBuffer_t *pInChannel,
                                                sBuffer_t *pWeights,
                                                sBuffer_t *pBias,
...
#endif /* VLIB_CONV_I16S_C16S_O32S_5X5_SKIP2_TILE_CN_H_ */

/* ======================================================================== */
/*  End of file:  VLIB_conv_i16s_c16s_o32s_5x5_skip2_tile_cn.h              */
/* ======================================================================== */
