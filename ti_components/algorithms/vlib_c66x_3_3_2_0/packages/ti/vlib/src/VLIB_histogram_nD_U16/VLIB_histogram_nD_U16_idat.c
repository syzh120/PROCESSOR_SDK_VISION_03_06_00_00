...
static histogram_nD_U16_testParams_t    testParams[]=
{
    /********************************************
        {
           testPattern,
           *staticIn, *numBins, *normVals, *staticOut,
           numX, dimX, binWeight, maxSize
        },
    *********************************************/
    {
        STATIC,
        X0, numB0, normVals0, Href0,
        25, sizeof(numB0) / sizeof(numB0[0]), 1, 254
    },
    {
        RANDOM,
        NULL, numB1, NULL, NULL,
        4, sizeof(numB1) / sizeof(numB1[0]), 1, 25
    },
    {
        RANDOM,
        NULL, numB2, NULL, NULL,
        32, sizeof(numB2) / sizeof(numB2[0]), 2, 253
    },
    {
        RANDOM,
        NULL, numB3, NULL, NULL,
        64, sizeof(numB3) / sizeof(numB3[0]), 2, 253
    },
    {
        RANDOM,
        NULL, numB4, NULL, NULL,
        512, sizeof(numB4) / sizeof(numB4[0]), 2, 253
    },
    {
        RANDOM,
        NULL, numB5, NULL, NULL,
        4096, sizeof(numB5) / sizeof(numB5[0]), 5, 200
    },
    {
        RANDOM,
        NULL, numB6, NULL, NULL,
        4096, sizeof(numB6) / sizeof(numB6[0]), 3, 512
    }
};
...
{
    *params = testParams;
    *numTests = sizeof(testParams) / sizeof(histogram_nD_U16_testParams_t);
}
