...
#ifndef VLIB_HIST_INIT_U16_IDAT_H

#define VLIB_HIST_INIT_U16_IDAT_H
...
} histogram_1D_Init_U16_testParams_t;

void histogram_1D_Init_U16_getTestParams(histogram_1D_Init_U16_testParams_t * *params, int32_t *numTests);

#endif /* define VLIB_HIST_INIT_U16_IDAT_H */

/* ======================================================================== */
/*  End of file:  VLIB_histogram_1D_Init_U16_idat.h                         */
/* ======================================================================== */
