...
static histogram_1D_U8_testParams_t    testParams[]=
{
    /********************************************
        {
           testPattern,
           *staticInEdges, *staticInImg, *staticOut,
           numX, numBins, binWeight, maxSize
        },
    *********************************************/
    {
        STATIC,
        ...
        sizeof(binEdges0) / sizeof(binEdges0[0]),
        1, 254
    },
    {
        RANDOM,
        binEdges1, NULL, NULL,
        64, sizeof(binEdges1) / sizeof(binEdges1[0]), 1, 25
    },
    {
        RANDOM,
        binEdges2, NULL, NULL,
        512, sizeof(binEdges2) / sizeof(binEdges2[0]), 2, 253
    },
    {
        RANDOM,
        binEdges3, NULL, NULL,
        4096, sizeof(binEdges3) / sizeof(binEdges3[0]), 5, 200
    }
};
 ...
 */
void histogram_1D_U8_getTestParams(histogram_1D_U8_testParams_t * *params, int32_t *numTests)
{
    *params = testParams;
    *numTests = sizeof(testParams) / sizeof(histogram_1D_U8_testParams_t);
}
