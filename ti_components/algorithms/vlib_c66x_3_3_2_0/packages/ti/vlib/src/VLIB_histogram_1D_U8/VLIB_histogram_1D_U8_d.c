...
#include "VLIB_histogram_1D_U8_cn.h"
#include "VLIB_histogram_1D_U8_idat.h"

#include "../VLIB_histogram_1D_Init_U8/VLIB_histogram_1D_Init_U8_cn.h"

/*VLIB_histogram_1D_U8_d:  Test Driver Routine */
void VLIB_histogram_1D_U8_d (uint8_t LevelOfFeedback)
{
    int32_t    tpi;  /* test parameter index */

    /* Test Parameters */
    histogram_1D_U8_testParams_t   *prm;

    histogram_1D_U8_getTestParams(&prm, &test_cases);

    /* Initialize profiling */
    VLIB_profile_init(2, "VLIB_histogram_1D_U8");
    ...
    for( tpi=0; tpi < test_cases; tpi++ ) {
        ...
        if( binEdges && histArray && X && H && H_cn && H1 && H2 && H3 ) {
            ...
            VLIB_histogram_1D_U8(X, prm[tpi].numX, numBinsH, prm[tpi].binWeight, histArray, H1, H2, H3, H);
            VLIB_profile_stop();
            ...
            VLIB_histogram_1D_U8_cn(X, prm[tpi].numX, numBinsH, prm[tpi].binWeight, histArray, H1, H2, H3, H_cn);
            VLIB_profile_stop();
...
main() {
    if( VLIB_cache_init()) {
        VLIB_memError("VLIB_histogram_1D_U8");
    } else {
        VLIB_histogram_1D_U8_d(0);
    }
}
#endif /* __ONESHOTTEST */

/* ======================================================================== */
/*  End of file:  VLIB_histogram_1D_U8_d.c                                  */
/* ======================================================================== */
