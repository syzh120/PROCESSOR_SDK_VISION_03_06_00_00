...
MEMORY
{
    /* Vector table for IPU1_0 is copied to 0x00000400U during the init */
...
SECTIONS
{
    ...
    .init    : load > DDR3_IPU1_0

    .text    : load > DDR3_IPU1_0 /* CODE                         */
    .data    : load > DDR3_IPU1_0 /* INITIALIZED GLOBAL AND STATIC VARIABLES. */
    .bss     : load > DDR3_IPU1_0 /* UNINITIALIZED OR ZERO INITIALIZED */
                                            /* GLOBAL & STATIC VARIABLES.   */
                    RUN_START(bss_start)
                    RUN_END(bss_end)
    .const   : load > DDR3_IPU1_0              /* GLOBAL CONSTANTS             */
    .cinit   : load > DDR3_IPU1_0
    .stack   : load > DDR3_IPU1_0            /* SOFTWARE SYSTEM STACK        */
    .plt     : load > DDR3_IPU1_0
    .sysmem  : load > DDR3_IPU1_0
    .my_sect_ddr : load > DDR3_IPU1_0
