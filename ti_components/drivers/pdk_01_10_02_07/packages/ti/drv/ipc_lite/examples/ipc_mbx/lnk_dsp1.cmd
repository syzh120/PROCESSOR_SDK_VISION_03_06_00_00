...
SECTIONS
{
    ...
    .text    : load > DDR3_DSP1              /* CODE                         */
    .data    : load > DDR3_DSP1              /* INITIALIZED GLOBAL AND STATIC VARIABLES. */
                                            /* GLOBAL & STATIC VARIABLES.   */
                    RUN_START(bss_start)
                    RUN_END(bss_end)
    .const   : load > DDR3_DSP1              /* GLOBAL CONSTANTS             */
    .cinit   : load > DDR3_DSP1
    .stack   : load > DDR3_DSP1            /* SOFTWARE SYSTEM STACK        */
    .far     : load > DDR3_DSP1
    .plt     : load > DDR3_DSP1
    .fardata : load > DDR3_DSP1
    .switch  : load > DDR3_DSP1
    .my_sect_ddr : load > DDR3_DSP1
    .sysmem : load > DDR3_DSP1
}
