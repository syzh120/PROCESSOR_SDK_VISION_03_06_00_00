...
MEMORY
{
    /* Vector table for IPU1_1 is copied to 0x00000800U during the init */
...
SECTIONS
{
    ...
    .init    : load > DDR3_IPU1_1

    .text    : load > DDR3_IPU1_1 /* CODE                         */
    .data    : load > DDR3_IPU1_1 /* INITIALIZED GLOBAL AND STATIC VARIABLES. */
    .bss     : load > DDR3_IPU1_1 /* UNINITIALIZED OR ZERO INITIALIZED */
                                            /* GLOBAL & STATIC VARIABLES.   */
                    RUN_START(bss_start)
                    RUN_END(bss_end)
    .const   : load > DDR3_IPU1_1              /* GLOBAL CONSTANTS             */
    .cinit   : load > DDR3_IPU1_1
    .stack   : load > DDR3_IPU1_1            /* SOFTWARE SYSTEM STACK        */
    .plt     : load > DDR3_IPU1_1
    .sysmem  : load > DDR3_IPU1_1
    .my_sect_ddr : load > DDR3_IPU1_1
