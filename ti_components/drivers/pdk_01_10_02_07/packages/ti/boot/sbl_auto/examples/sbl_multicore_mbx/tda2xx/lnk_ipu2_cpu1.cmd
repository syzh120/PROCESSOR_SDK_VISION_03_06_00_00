...
SECTIONS
{
    ...
    .init    : load > DDR3_IPU2_CPU1_CODE

    .text    : load > DDR3_IPU2_CPU1_CODE /* CODE                         */
    .data    : load > DDR3_IPU2_CPU1_DATA /* INITIALIZED GLOBAL AND STATIC VARIABLES. */
    .bss     : load > DDR3_IPU2_CPU1_DATA /* UNINITIALIZED OR ZERO INITIALIZED */
                                            /* GLOBAL & STATIC VARIABLES.   */
                    RUN_START(bss_start)
                    RUN_END(bss_end)
    .const   : load > DDR3_IPU2_CPU1_DATA              /* GLOBAL CONSTANTS             */
    .cinit   : load > DDR3_IPU2_CPU1_DATA
    .stack   : load > DDR3_IPU2_CPU1_STACK            /* SOFTWARE SYSTEM STACK        */
    .plt     : load > DDR3_IPU2_CPU1_CODE
    .sysmem  : load > DDR3_IPU2_CPU1_DATA
	.my_sect_ddr : load > DDR3_IPU2_CPU1_CODE
}
