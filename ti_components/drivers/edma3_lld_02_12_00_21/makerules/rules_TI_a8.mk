...
ifneq ($(XDC_CFG_FILE_$(CORE)),)
  ifeq ($(PROFILE_$(CORE)),debug)
    CFG_CFILENAMEPART_XDC =p$(FORMAT_EXT)a8fnv
  endif
...
ifeq ($(PROFILE_$(CORE)), debug)
 CFLAGS_XDCINTERNAL = -g --symdebug:dwarf -Dxdc_target_name__=A8F -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_4_6_1 -D_DEBUG_=1 -O2
 ifndef MODULE_NAME
