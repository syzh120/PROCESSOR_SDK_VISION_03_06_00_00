...
ifeq ($(FORMAT),COFF)
CODEGEN_PATH = $(CODEGEN_PATH_M3_COFF)
CODEGEN_INCLUDE = $(CODEGEN_PATH_M3_COFF)/include
CC = $(CODEGEN_PATH_M3_COFF)/bin/armcl 
AR = $(CODEGEN_PATH_M3_COFF)/bin/armar
LNK = $(CODEGEN_PATH_M3_COFF)/bin/armlnk
endif
ifeq ($(FORMAT),ELF)
CODEGEN_PATH = $(CODEGEN_PATH_M3)
...
RTSLIB_PATH = $(CODEGEN_PATH)/lib/rtsv7M3_T_$(RTSLIB_ENDIAN)_$(RTSLIB_FORMAT).lib
